...
import org.finos.flowave.bpm.spring.boot.starter.spin.FlowaveJacksonFormatConfiguratorJSR310;
import org.finos.flowave.bpm.spring.boot.starter.spin.FlowaveJacksonFormatConfiguratorJdk8;
import org.finos.flowave.bpm.spring.boot.starter.spin.FlowaveJacksonFormatConfiguratorParameterNames;
...
@Configuration
public class FlowaveBpmPluginConfiguration {
  ...
  */
  ...
  static class SpinDataFormatConfigurationJSR310 {
    ...
    public static FlowaveJacksonFormatConfiguratorJSR310 spinDataFormatConfiguratorJSR310() {
      return new FlowaveJacksonFormatConfiguratorJSR310();
    }
  ...
  static class SpinDataFormatConfigurationParameterNames {
    ...
    public static FlowaveJacksonFormatConfiguratorParameterNames spinDataFormatConfiguratorParameterNames() {
      return new FlowaveJacksonFormatConfiguratorParameterNames();
    }
  ...
  static class SpinDataFormatConfigurationJdk8 {
    ...
    public static FlowaveJacksonFormatConfiguratorJdk8 spinDataFormatConfiguratorJdk8() {
      return new FlowaveJacksonFormatConfiguratorJdk8();
    }
