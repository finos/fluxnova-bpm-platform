...
@EnableConfigurationProperties({
  FlowaveBpmProperties.class,
  ManagementProperties.class
})
@Import({
  FlowaveBpmConfiguration.class,
  FlowaveBpmActuatorConfiguration.class,
  FlowaveBpmPluginConfiguration.class,
  FlowaveBpmTelemetryConfiguration.class,
  SpringProcessEngineServicesConfiguration.class
})
@Configuration
@ConditionalOnProperty(prefix = FlowaveBpmProperties.PREFIX, name = "enabled", matchIfMissing = true)
@AutoConfigureAfter(HibernateJpaAutoConfiguration.class)
public class FlowaveBpmAutoConfiguration {
  ...
  @Bean
  public FlowaveBpmVersion flowaveBpmVersion() {
    return new FlowaveBpmVersion();
  }
