...
import static org.finos.flowave.bpm.spring.boot.starter.property.FlowaveBpmProperties.PREFIX;
 ...
 */
public class FlowaveBpmVersion implements Supplier<String> {
  ...
  public FlowaveBpmVersion() {
    this(ProcessEngine.class.getPackage());
  }

  FlowaveBpmVersion(final Package pkg) {
