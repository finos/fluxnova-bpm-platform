 ...
 * </p>
 */
public class FlowaveBpmNestedRuntimeException extends NestedRuntimeException {
   ...
   */
  public FlowaveBpmNestedRuntimeException(final String msg) {
    super(msg);
  }
   ...
   */
  public FlowaveBpmNestedRuntimeException(final String msg, final Throwable cause) {
    super(msg, cause);
  }
