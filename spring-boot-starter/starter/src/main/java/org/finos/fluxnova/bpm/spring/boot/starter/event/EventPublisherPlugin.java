...
import org.finos.fluxnova.bpm.spring.boot.starter.property.EventingProperty;
import org.finos.fluxnova.bpm.spring.boot.starter.util.SpringBootProcessEnginePlugin;
...
public class EventPublisherPlugin extends SpringBootProcessEnginePlugin {
  ...
  public EventPublisherPlugin(final FluxnovaBpmProperties properties, final ApplicationEventPublisher publisher) {
