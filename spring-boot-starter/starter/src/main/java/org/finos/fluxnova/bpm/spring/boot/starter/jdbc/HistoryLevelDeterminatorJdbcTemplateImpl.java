...
public class HistoryLevelDeterminatorJdbcTemplateImpl implements HistoryLevelDeterminator, InitializingBean {
  ...
  public static HistoryLevelDeterminator createHistoryLevelDeterminator(FluxnovaBpmProperties camundaBpmProperties, JdbcTemplate jdbcTemplate) {
  ...
  public FluxnovaBpmProperties getFluxnovaBpmProperties() {
    return camundaBpmProperties;
  }

  public void setFluxnovaBpmProperties(FluxnovaBpmProperties camundaBpmProperties) {
