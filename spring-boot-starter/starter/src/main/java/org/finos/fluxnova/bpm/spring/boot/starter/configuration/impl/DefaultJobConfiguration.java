...
import org.finos.fluxnova.bpm.engine.spring.components.jobexecutor.SpringJobExecutor;
import org.finos.fluxnova.bpm.spring.boot.starter.configuration.FluxnovaJobConfiguration;
import org.finos.fluxnova.bpm.spring.boot.starter.event.JobExecutorStartingEventListener;
import org.finos.fluxnova.bpm.spring.boot.starter.property.FluxnovaBpmProperties;
import org.finos.fluxnova.bpm.spring.boot.starter.property.JobExecutionProperty;
 ...
 */
public class DefaultJobConfiguration extends AbstractFluxnovaConfiguration implements FluxnovaJobConfiguration {
  ...
  protected void configureJobExecutor(SpringProcessEngineConfiguration configuration) {
    ...
    // org.finos.fluxnova.bpm.spring.boot.starter.runlistener.JobExecutorRunListener
  ...
  public static class JobConfiguration {
    ...
    @ConditionalOnProperty(prefix = "fluxnova.bpm.job-execution", name = "enabled", havingValue = "true",
        matchIfMissing = true)
    public static TaskExecutor fluxnovaTaskExecutor(FluxnovaBpmProperties properties) {
    ...
    @ConditionalOnProperty(prefix = "fluxnova.bpm.job-execution", name = "enabled", havingValue = "true", matchIfMissing = true)
    public static JobExecutor jobExecutor(@Qualifier(CAMUNDA_TASK_EXECUTOR_QUALIFIER) final TaskExecutor taskExecutor, FluxnovaBpmProperties properties) {
