...
import static org.finos.flowave.bpm.spring.boot.starter.util.FlowaveBpmVersion.key;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.when;

import java.io.IOException;

public class FlowaveBpmVersionTest {
  ...
  public void currentVersion() {
    ...
    assertThat(source.getName()).isEqualTo("FlowaveBpmVersion");
    final String versionFromPropertiesSource = (String) source.getProperty(key(FlowaveBpmVersion.VERSION));
    assertThat(versionFromPropertiesSource).startsWith(currentVersion);
    assertThat(source.getProperty(key(FlowaveBpmVersion.FORMATTED_VERSION))).isEqualTo("(v" + versionFromPropertiesSource + ")");
    assertThat(source.getProperty(key(FlowaveBpmVersion.IS_ENTERPRISE))).isEqualTo(Boolean.FALSE);
  }
