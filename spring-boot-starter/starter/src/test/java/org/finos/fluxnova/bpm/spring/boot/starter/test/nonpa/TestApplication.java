 ...
 */
package org.finos.fluxnova.bpm.spring.boot.starter.test.nonpa;
...
public class TestApplication {
  ...
  @ConditionalOnProperty(prefix = "fluxnova.bpm", name = "process-engine-name", havingValue = "nojpaTestEngine")
  @Configuration
