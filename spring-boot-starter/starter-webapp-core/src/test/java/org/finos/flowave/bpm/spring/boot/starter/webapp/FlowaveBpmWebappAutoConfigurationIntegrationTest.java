...
public class FlowaveBpmWebappAutoConfigurationIntegrationTest {

  private String bpmEnabled = FlowaveBpmProperties.PREFIX + ".enabled=true";

  private String bpmDisabled = FlowaveBpmProperties.PREFIX + ".enabled=false";
  ...
  @Before
  public void setUp() {
    AutoConfigurations autoConfigurationsUnderTest = AutoConfigurations.of(FlowaveBpmAutoConfiguration.class, FlowaveBpmWebappAutoConfiguration.class);
  ...
  public void test_bpmIsNotDisabled_and_webappIsNotDisabled_shouldInitWebapp() {
    contextRunner.run(context -> {
      ...
      assertThat(context).hasSingleBean(FlowaveBpmWebappInitializer.class);
  ...
  public void test_bpmIsDisabled_and_webappIsNotDisabled_shouldNotInitWebapp() {
    contextRunner.withPropertyValues(bpmDisabled).run(context -> {
      assertThat(context).hasNotFailed();
      assertThat(context).doesNotHaveBean(FlowaveBpmWebappInitializer.class);
