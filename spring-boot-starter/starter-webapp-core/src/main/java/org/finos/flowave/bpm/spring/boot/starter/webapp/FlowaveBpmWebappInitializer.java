 ...
 */
public class FlowaveBpmWebappInitializer implements ServletContextInitializer {

  private static final Logger log = LoggerFactory.getLogger(FlowaveBpmWebappInitializer.class);

  private static final EnumSet<DispatcherType> DISPATCHER_TYPES = EnumSet.of(DispatcherType.REQUEST);

  private ServletContext servletContext;

  private final FlowaveBpmProperties properties;

  public FlowaveBpmWebappInitializer(FlowaveBpmProperties properties) {
