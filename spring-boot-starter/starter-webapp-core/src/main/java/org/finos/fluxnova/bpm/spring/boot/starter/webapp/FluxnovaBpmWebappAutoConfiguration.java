...
import org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.LazyInitRegistration;
import org.finos.fluxnova.bpm.spring.boot.starter.webapp.filter.ResourceLoaderDependingFilter;
...
public class FluxnovaBpmWebappAutoConfiguration implements WebMvcConfigurer {
  ...
  @Bean
  public FluxnovaBpmWebappInitializer fluxnovaBpmWebappInitializer() {
    return new FluxnovaBpmWebappInitializer(properties);
  }
