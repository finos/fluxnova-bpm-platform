...
public class FlowaveBpmRestJerseyAutoConfiguration {

  @Bean
  @ConditionalOnMissingBean(FlowaveJerseyResourceConfig.class)
  public FlowaveJerseyResourceConfig createRestConfig() {
    return new FlowaveJerseyResourceConfig();
  }
