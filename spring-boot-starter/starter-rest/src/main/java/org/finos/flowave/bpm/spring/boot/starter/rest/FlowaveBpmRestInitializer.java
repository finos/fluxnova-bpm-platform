 ...
 */
public class FlowaveBpmRestInitializer implements ServletContextInitializer {

  private static final Logger log = LoggerFactory.getLogger(FlowaveBpmRestInitializer.class);
  ...
  public FlowaveBpmRestInitializer(JerseyApplicationPath applicationPath) {
