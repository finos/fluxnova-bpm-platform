...
public class FlowaveBpmSampleApplicationIT extends AbstractSpringSecurityIT {
  ...
  public void testSpringSecurityAutoConfigurationCorrectlySet() {
    ...
    assertThat(getBeanForClass(FlowaveSpringSecurityOAuth2AutoConfiguration.class, webApplicationContext)).isNull();
    assertThat(getBeanForClass(FlowaveBpmSpringSecurityDisableAutoConfiguration.class, webApplicationContext)).isNotNull();
  }
