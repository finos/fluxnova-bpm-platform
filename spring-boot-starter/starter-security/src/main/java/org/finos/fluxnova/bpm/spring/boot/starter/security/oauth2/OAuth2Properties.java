...
import org.finos.fluxnova.bpm.spring.boot.starter.security.oauth2.impl.OAuth2IdentityProvider;
...
public class OAuth2Properties {
  ...
  public static final String PREFIX = FluxnovaBpmProperties.PREFIX + ".oauth2";
