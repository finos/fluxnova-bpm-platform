...
public class DeploymentQueryDto extends AbstractQueryDto<DeploymentQuery> {
  ...
  @FlowaveQueryParam("source")
  public void setSource(String source) {
    this.source = source;
  }

  @FlowaveQueryParam(value = "withoutSource", converter = BooleanConverter.class)
  public void setWithoutSource(Boolean withoutSource) {
    this.withoutSource = withoutSource;
  }

  @FlowaveQueryParam(value = "before", converter = DateConverter.class)
  public void setDeploymentBefore(Date deploymentBefore) {
    this.before = deploymentBefore;
  }

  @FlowaveQueryParam(value = "after", converter = DateConverter.class)
  ...
  @FlowaveQueryParam(value = "includeDeploymentsWithoutTenantId", converter = BooleanConverter.class)
