...
import org.finos.fluxnova.spin.xml.SpinXmlElementImplementationException;
...
public class DomXmlLogger extends SpinLogger {
  ...
  public static final DomXmlLogger XML_DOM_LOGGER = BaseLogger.createLogger(DomXmlLogger.class, PROJECT_CODE, "org.finos.fluxnova.spin.xml", "01");
