...
public class FlowaveVariableTransitionEventImpl  extends CmmnModelElementInstanceImpl implements FlowaveVariableTransitionEvent {

  public FlowaveVariableTransitionEventImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveVariableTransitionEvent.class, CAMUNDA_ELEMENT_VARIABLE_EVENT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveVariableTransitionEvent>() {
        public FlowaveVariableTransitionEvent newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveVariableTransitionEventImpl(instanceContext);
      }
    });
