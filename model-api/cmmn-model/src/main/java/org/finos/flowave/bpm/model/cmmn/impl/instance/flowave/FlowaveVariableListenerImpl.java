 ...
 */
public class FlowaveVariableListenerImpl extends CmmnModelElementInstanceImpl implements FlowaveVariableListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveVariableListener.class, CAMUNDA_ELEMENT_VARIABLE_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveVariableListener>() {
        public FlowaveVariableListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveVariableListenerImpl(instanceContext);
        }
      });
