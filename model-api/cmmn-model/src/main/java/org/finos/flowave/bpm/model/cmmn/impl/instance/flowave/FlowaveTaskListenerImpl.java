 ...
 *
 */
public class FlowaveTaskListenerImpl extends CmmnModelElementInstanceImpl implements FlowaveTaskListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveTaskListener.class, CAMUNDA_ELEMENT_TASK_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveTaskListener>() {
        public FlowaveTaskListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveTaskListenerImpl(instanceContext);
        }
      });
  ...
  public FlowaveTaskListenerImpl(ModelTypeInstanceContext instanceContext) {
