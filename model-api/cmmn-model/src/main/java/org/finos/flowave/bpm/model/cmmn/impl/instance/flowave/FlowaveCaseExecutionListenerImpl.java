 ...
 *
 */
public class FlowaveCaseExecutionListenerImpl extends CmmnModelElementInstanceImpl implements FlowaveCaseExecutionListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveCaseExecutionListener.class, CAMUNDA_ELEMENT_CASE_EXECUTION_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveCaseExecutionListener>() {
        public FlowaveCaseExecutionListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveCaseExecutionListenerImpl(instanceContext);
        }
      });
  ...
  public FlowaveCaseExecutionListenerImpl(ModelTypeInstanceContext instanceContext) {
