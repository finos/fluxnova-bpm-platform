...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_DECISION_BINDING;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_DECISION_VERSION;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_DECISION_TENANT_ID;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_MAP_DECISION_RESULT;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_RESULT_VARIABLE;
...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ATTRIBUTE_DECISION_REF;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ELEMENT_DECISION_TASK;
...
import org.finos.fluxnova.bpm.model.cmmn.instance.ParameterMapping;
...
public class DecisionTaskImpl extends TaskImpl implements DecisionTask {
  ...
  public String getFluxnovaDecisionBinding() {
    return camundaDecisionBindingAttribute.getValue(this);
  }

  public void setFluxnovaDecisionBinding(String camundaDecisionBinding) {
    camundaDecisionBindingAttribute.setValue(this, camundaDecisionBinding);
  }

  public String getFluxnovaDecisionVersion() {
    return camundaDecisionVersionAttribute.getValue(this);
  }

  public void setFluxnovaDecisionVersion(String camundaDecisionVersion) {
    camundaDecisionVersionAttribute.setValue(this, camundaDecisionVersion);
  }

  public String getFluxnovaDecisionTenantId() {
    return camundaDecisionTenantIdAttribute.getValue(this);
  }

  public void setFluxnovaDecisionTenantId(String camundaDecisionTenantId) {
