...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_PROCESS_BINDING;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_PROCESS_VERSION;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ATTRIBUTE_PROCESS_TENANT_ID;
...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ATTRIBUTE_PROCESS_REF;
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CMMN_ELEMENT_PROCESS_TASK;

import java.util.Collection;

import org.finos.fluxnova.bpm.model.cmmn.instance.ParameterMapping;
import org.finos.fluxnova.bpm.model.cmmn.instance.ProcessRefExpression;
...
public class ProcessTaskImpl extends TaskImpl implements ProcessTask {
  ...
  public String getFluxnovaProcessBinding() {
    return camundaProcessBindingAttribute.getValue(this);
  }

  public void setFluxnovaProcessBinding(String camundaProcessBinding) {
    camundaProcessBindingAttribute.setValue(this, camundaProcessBinding);
  }

  public String getFluxnovaProcessVersion() {
    return camundaProcessVersionAttribute.getValue(this);
  }

  public void setFluxnovaProcessVersion(String camundaProcessVersion) {
    camundaProcessVersionAttribute.setValue(this, camundaProcessVersion);
  }

  public String getFluxnovaProcessTenantId() {
    return camundaProcessTenantIdAttribute.getValue(this);
  }

  public void setFluxnovaProcessTenantId(String camundaProcessTenantId) {
