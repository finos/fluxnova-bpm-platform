...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ELEMENT_VARIABLE_EVENT;
...
public class FluxnovaVariableTransitionEventImpl  extends CmmnModelElementInstanceImpl implements FluxnovaVariableTransitionEvent {

  public FluxnovaVariableTransitionEventImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaVariableTransitionEvent.class, CAMUNDA_ELEMENT_VARIABLE_EVENT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaVariableTransitionEvent>() {
        public FluxnovaVariableTransitionEvent newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaVariableTransitionEventImpl(instanceContext);
      }
    });
