...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ELEMENT_STRING;
 ...
 *
 */
public class FluxnovaStringImpl extends CmmnModelElementInstanceImpl implements FluxnovaString {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaString.class, CAMUNDA_ELEMENT_STRING)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaString>() {
        public FluxnovaString newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaStringImpl(instanceContext);
        }
      });
  ...
  public FluxnovaStringImpl(ModelTypeInstanceContext instanceContext) {
