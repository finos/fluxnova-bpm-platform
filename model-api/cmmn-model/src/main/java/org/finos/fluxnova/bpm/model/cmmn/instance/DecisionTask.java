...
public interface DecisionTask extends Task {
  ...
  String getFluxnovaDecisionBinding();

  void setFluxnovaDecisionBinding(String camundaDecisionBinding);

  String getFluxnovaDecisionVersion();

  void setFluxnovaDecisionVersion(String camundaDecisionVersion);

  String getFluxnovaDecisionTenantId();

  void setFluxnovaDecisionTenantId(String camundaDecisionTenantId);
