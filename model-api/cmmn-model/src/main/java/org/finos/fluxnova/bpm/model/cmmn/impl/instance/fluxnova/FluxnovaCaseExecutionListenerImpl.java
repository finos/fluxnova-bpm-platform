...
import static org.finos.fluxnova.bpm.model.cmmn.impl.CmmnModelConstants.CAMUNDA_ELEMENT_CASE_EXECUTION_LISTENER;
 ...
 *
 */
public class FluxnovaCaseExecutionListenerImpl extends CmmnModelElementInstanceImpl implements FluxnovaCaseExecutionListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaCaseExecutionListener.class, CAMUNDA_ELEMENT_CASE_EXECUTION_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaCaseExecutionListener>() {
        public FluxnovaCaseExecutionListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaCaseExecutionListenerImpl(instanceContext);
        }
      });
  ...
  public FluxnovaCaseExecutionListenerImpl(ModelTypeInstanceContext instanceContext) {
