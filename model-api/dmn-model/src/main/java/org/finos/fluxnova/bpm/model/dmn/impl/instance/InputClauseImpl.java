...
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.CAMUNDA_ATTRIBUTE_INPUT_VARIABLE;
...
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.DMN_ELEMENT_INPUT_CLAUSE;

import org.finos.fluxnova.bpm.model.dmn.instance.DmnElement;
import org.finos.fluxnova.bpm.model.dmn.instance.InputClause;
...
public class InputClauseImpl extends DmnElementImpl implements InputClause {
  ...
  public String getFluxnovaInputVariable() {
    return camundaInputVariableAttribute.getValue(this);
  }


  public void setFluxnovaInputVariable(String inputVariable) {
