 ...
 */
package org.finos.fluxnova.bpm.model.dmn.impl.instance;

import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.CAMUNDA_ATTRIBUTE_HISTORY_TIME_TO_LIVE;
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.CAMUNDA_ATTRIBUTE_VERSION_TAG;
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.CAMUNDA_NS;
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.LATEST_DMN_NS;
import static org.finos.fluxnova.bpm.model.dmn.impl.DmnModelConstants.DMN_ELEMENT_DECISION;

import java.util.Collection;

import org.finos.fluxnova.bpm.model.dmn.instance.AllowedAnswers;
import org.finos.fluxnova.bpm.model.dmn.instance.AuthorityRequirement;
import org.finos.fluxnova.bpm.model.dmn.instance.Decision;
import org.finos.fluxnova.bpm.model.dmn.instance.DecisionMakerReference;
import org.finos.fluxnova.bpm.model.dmn.instance.DecisionOwnerReference;
import org.finos.fluxnova.bpm.model.dmn.instance.DrgElement;
import org.finos.fluxnova.bpm.model.dmn.instance.Expression;
import org.finos.fluxnova.bpm.model.dmn.instance.ImpactedPerformanceIndicatorReference;
import org.finos.fluxnova.bpm.model.dmn.instance.InformationRequirement;
import org.finos.fluxnova.bpm.model.dmn.instance.KnowledgeRequirement;
import org.finos.fluxnova.bpm.model.dmn.instance.OrganizationUnit;
import org.finos.fluxnova.bpm.model.dmn.instance.PerformanceIndicator;
import org.finos.fluxnova.bpm.model.dmn.instance.Question;
import org.finos.fluxnova.bpm.model.dmn.instance.SupportedObjectiveReference;
import org.finos.fluxnova.bpm.model.dmn.instance.UsingProcessReference;
import org.finos.fluxnova.bpm.model.dmn.instance.UsingTaskReference;
...
public class DecisionImpl extends DrgElementImpl implements Decision {
  ...
  public void setFluxnovaHistoryTimeToLive(Integer historyTimeToLive) {
    setFluxnovaHistoryTimeToLiveString(String.valueOf(historyTimeToLive));
  }
