 ...
 */
public class FlowaveFieldTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(CAMUNDA_NS, FlowaveExpression.class, 0, 1),
      new ChildElementAssumption(CAMUNDA_NS, FlowaveString.class, 0, 1)
    );
  }
