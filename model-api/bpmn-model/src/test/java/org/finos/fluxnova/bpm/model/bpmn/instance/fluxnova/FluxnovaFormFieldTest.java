 ...
 */
public class FluxnovaFormFieldTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaProperties.class, 0, 1),
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaValidation.class, 0, 1),
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaValue.class)
    );
  }
