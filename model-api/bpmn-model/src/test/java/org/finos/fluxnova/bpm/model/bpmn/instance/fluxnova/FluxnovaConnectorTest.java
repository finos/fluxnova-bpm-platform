...
public class FluxnovaConnectorTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaConnectorId.class, 1, 1),
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaInputOutput.class, 0, 1)
    );
  }
