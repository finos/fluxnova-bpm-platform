 ...
 */
public class FluxnovaInputOutputTest extends BpmnModelElementInstanceTest {
  ...
  public Collection<ChildElementAssumption> getChildElementAssumptions() {
    return Arrays.asList(
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaInputParameter.class),
      new ChildElementAssumption(CAMUNDA_NS, FluxnovaOutputParameter.class)
    );
  }
