 ...
 */
public class FlowaveListImpl extends BpmnModelElementInstanceImpl implements FlowaveList {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveList.class, CAMUNDA_ELEMENT_LIST)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveList>() {
        public FlowaveList newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveListImpl(instanceContext);
        }
      });
  ...
  public FlowaveListImpl(ModelTypeInstanceContext instanceContext) {
