 ...
 */
public class FlowaveConnectorIdImpl extends BpmnModelElementInstanceImpl implements FlowaveConnectorId {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveConnectorId.class, CAMUNDA_ELEMENT_CONNECTOR_ID)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveConnectorId>() {
        public FlowaveConnectorId newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveConnectorIdImpl(instanceContext);
        }
      });
  ...
  public FlowaveConnectorIdImpl(ModelTypeInstanceContext instanceContext) {
