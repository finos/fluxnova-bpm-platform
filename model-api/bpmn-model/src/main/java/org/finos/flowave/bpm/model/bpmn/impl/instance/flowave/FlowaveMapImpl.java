 ...
 */
public class FlowaveMapImpl extends BpmnModelElementInstanceImpl implements FlowaveMap {

  protected static ChildElementCollection<FlowaveEntry> camundaEntryCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveMap.class, BpmnModelConstants.CAMUNDA_ELEMENT_MAP)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveMap>() {
        public FlowaveMap newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveMapImpl(instanceContext);
        }
      });

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaEntryCollection = sequenceBuilder.elementCollection(FlowaveEntry.class)
      .build();

    typeBuilder.build();
  }

  public FlowaveMapImpl(ModelTypeInstanceContext instanceContext) {
