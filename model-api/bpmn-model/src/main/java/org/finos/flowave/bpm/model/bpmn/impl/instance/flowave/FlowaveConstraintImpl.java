 ...
 */
public class FlowaveConstraintImpl extends BpmnModelElementInstanceImpl implements FlowaveConstraint {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveConstraint.class, CAMUNDA_ELEMENT_CONSTRAINT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveConstraint>() {
        public FlowaveConstraint newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveConstraintImpl(instanceContext);
        }
      });
  ...
  public FlowaveConstraintImpl(ModelTypeInstanceContext instanceContext) {
