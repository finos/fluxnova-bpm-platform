...
public class FlowaveErrorEventDefinitionImpl extends ErrorEventDefinitionImpl implements FlowaveErrorEventDefinition {

  protected static Attribute<String> camundaExpressionAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowaveErrorEventDefinition.class, CAMUNDA_ELEMENT_ERROR_EVENT_DEFINITION)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FlowaveErrorEventDefinition>() {
        public FlowaveErrorEventDefinition newInstance(ModelTypeInstanceContext instanceContext) {
          return new FlowaveErrorEventDefinitionImpl(instanceContext);
        }
      });
  ...
  public FlowaveErrorEventDefinitionImpl(ModelTypeInstanceContext instanceContext) {
