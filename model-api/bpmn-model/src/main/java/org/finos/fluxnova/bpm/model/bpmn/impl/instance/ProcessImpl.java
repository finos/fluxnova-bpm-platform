...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_CLOSED;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_EXECUTABLE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_PROCESS_TYPE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_PROCESS;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_GROUPS;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_USERS;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_HISTORY_TIME_TO_LIVE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_IS_STARTABLE_IN_TASKLIST;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_JOB_PRIORITY;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_TASK_PRIORITY;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VERSION_TAG;
...
import org.finos.fluxnova.bpm.model.bpmn.instance.Artifact;
import org.finos.fluxnova.bpm.model.bpmn.instance.Auditing;
import org.finos.fluxnova.bpm.model.bpmn.instance.CallableElement;
import org.finos.fluxnova.bpm.model.bpmn.instance.CorrelationSubscription;
import org.finos.fluxnova.bpm.model.bpmn.instance.FlowElement;
import org.finos.fluxnova.bpm.model.bpmn.instance.LaneSet;
import org.finos.fluxnova.bpm.model.bpmn.instance.Monitoring;
import org.finos.fluxnova.bpm.model.bpmn.instance.Process;
import org.finos.fluxnova.bpm.model.bpmn.instance.Property;
...
public class ProcessImpl extends CallableElementImpl implements Process {
  ...
  public String getFluxnovaCandidateStarterGroups() {
    return camundaCandidateStarterGroupsAttribute.getValue(this);
  }

  public void setFluxnovaCandidateStarterGroups(String camundaCandidateStarterGroups) {
    camundaCandidateStarterGroupsAttribute.setValue(this, camundaCandidateStarterGroups);
  }

  public List<String> getFluxnovaCandidateStarterGroupsList() {
  ...
  public void setFluxnovaCandidateStarterGroupsList(List<String> camundaCandidateStarterGroupsList) {
  ...
  public String getFluxnovaCandidateStarterUsers() {
    return camundaCandidateStarterUsersAttribute.getValue(this);
  }

  public void setFluxnovaCandidateStarterUsers(String camundaCandidateStarterUsers) {
    camundaCandidateStarterUsersAttribute.setValue(this, camundaCandidateStarterUsers);
  }

  public List<String> getFluxnovaCandidateStarterUsersList() {
  ...
  public void setFluxnovaCandidateStarterUsersList(List<String> camundaCandidateStarterUsersList) {
  ...
  @Override
  public Integer getFluxnovaHistoryTimeToLive() {
    String ttl = getFluxnovaHistoryTimeToLiveString();
    if (ttl != null) {
  ...
  @Override
  public void setFluxnovaHistoryTimeToLive(Integer historyTimeToLive) {
    var value = historyTimeToLive == null ? null : String.valueOf(historyTimeToLive);
    setFluxnovaHistoryTimeToLiveString(value);
  }

  @Override
  public String getFluxnovaHistoryTimeToLiveString() {
    return camundaHistoryTimeToLiveAttribute.getValue(this);
  }

  @Override
  public void setFluxnovaHistoryTimeToLiveString(String historyTimeToLive) {
  ...
  @Override
  public Boolean isFluxnovaStartableInTasklist() {
    return camundaIsStartableInTasklistAttribute.getValue(this);
  }

  @Override
  public void setFluxnovaIsStartableInTasklist(Boolean isStartableInTasklist) {
    camundaIsStartableInTasklistAttribute.setValue(this, isStartableInTasklist);
  }

  @Override
  public String getFluxnovaVersionTag() {
    return camundaVersionTagAttribute.getValue(this);
  }

  @Override
  public void setFluxnovaVersionTag(String versionTag) {
