...
public interface MultiInstanceLoopCharacteristics extends LoopCharacteristics {
  ...
  String getFluxnovaCollection();

  void setFluxnovaCollection(String expression);

  String getFluxnovaElementVariable();

  void setFluxnovaElementVariable(String variableName);

  boolean isFluxnovaAsyncBefore();

  void setFluxnovaAsyncBefore(boolean isCamundaAsyncBefore);

  boolean isFluxnovaAsyncAfter();

  void setFluxnovaAsyncAfter(boolean isCamundaAsyncAfter);

  boolean isFluxnovaExclusive();

  void setFluxnovaExclusive(boolean isCamundaExclusive);
