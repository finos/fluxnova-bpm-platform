...
public abstract class AbstractProcessBuilder<B extends AbstractProcessBuilder<B>> extends AbstractCallableElementBuilder<B, Process> {
   ...
   * @return the builder object
   */
  public B fluxnovaHistoryTimeToLive(Integer historyTimeToLive) {
    element.setFluxnovaHistoryTimeToLive(historyTimeToLive);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaHistoryTimeToLiveString(String historyTimeToLive) {
    element.setFluxnovaHistoryTimeToLiveString(historyTimeToLive);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaStartableInTasklist(Boolean isStartableInTasklist) {
    element.setFluxnovaIsStartableInTasklist(isStartableInTasklist);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaVersionTag(String versionTag) {
    element.setFluxnovaVersionTag(versionTag);
    return myself;
  }
}
