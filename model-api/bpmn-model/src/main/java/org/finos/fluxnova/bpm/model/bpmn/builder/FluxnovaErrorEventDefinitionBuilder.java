...
public class FluxnovaErrorEventDefinitionBuilder extends AbstractErrorEventDefinitionBuilder<FluxnovaErrorEventDefinitionBuilder> {

  public FluxnovaErrorEventDefinitionBuilder(BpmnModelInstance modelInstance, ErrorEventDefinition element) {
    super(modelInstance, element, FluxnovaErrorEventDefinitionBuilder.class);
  }

  public FluxnovaErrorEventDefinitionBuilder expression(String expression) {
