 ...
 */
public class FluxnovaConstraintImpl extends BpmnModelElementInstanceImpl implements FluxnovaConstraint {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaConstraint.class, CAMUNDA_ELEMENT_CONSTRAINT)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaConstraint>() {
        public FluxnovaConstraint newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaConstraintImpl(instanceContext);
        }
      });
  ...
  public FluxnovaConstraintImpl(ModelTypeInstanceContext instanceContext) {
  ...
  public String getFluxnovaConfig() {
    return camundaConfigAttribute.getValue(this);
  }

  public void setFluxnovaConfig(String camundaConfig) {
