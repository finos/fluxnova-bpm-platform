 ...
 */
public class FluxnovaValueImpl extends BpmnModelElementInstanceImpl implements FluxnovaValue {

  protected static Attribute<String> camundaIdAttribute;
  protected static Attribute<String> camundaNameAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaValue.class, CAMUNDA_ELEMENT_VALUE)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaValue>() {
        public FluxnovaValue newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaValueImpl(instanceContext);
        }
      });
  ...
  public FluxnovaValueImpl(ModelTypeInstanceContext instanceContext) {
