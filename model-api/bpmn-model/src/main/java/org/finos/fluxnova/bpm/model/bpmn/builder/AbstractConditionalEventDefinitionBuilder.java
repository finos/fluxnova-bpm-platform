...
public class AbstractConditionalEventDefinitionBuilder<B extends AbstractConditionalEventDefinitionBuilder<B>> extends AbstractRootElementBuilder<B, ConditionalEventDefinition>{
   ...
   * @return the builder object
   */
  public B fluxnovaVariableName(String variableName) {
    element.setFluxnovaVariableName(variableName);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaVariableEvents(String variableEvents) {
    element.setFluxnovaVariableEvents(variableEvents);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaVariableEvents(List<String> variableEvents) {
    element.setFluxnovaVariableEventsList(variableEvents);
    return myself;
  }
