...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_ERROR_REF;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_ERROR_EVENT_DEFINITION;
...
public class ErrorEventDefinitionImpl extends EventDefinitionImpl implements ErrorEventDefinition {
  ...
  @Override
  public void setFluxnovaErrorCodeVariable(String camundaErrorCodeVariable) {
    camundaErrorCodeVariableAttribute.setValue(this, camundaErrorCodeVariable);
  }

  @Override
  public String getFluxnovaErrorCodeVariable() {
    return camundaErrorCodeVariableAttribute.getValue(this);
  }

  @Override
  public void setFluxnovaErrorMessageVariable(String camundaErrorMessageVariable) {
    camundaErrorMessageVariableAttribute.setValue(this, camundaErrorMessageVariable);
  }

  @Override
  public String getFluxnovaErrorMessageVariable() {
