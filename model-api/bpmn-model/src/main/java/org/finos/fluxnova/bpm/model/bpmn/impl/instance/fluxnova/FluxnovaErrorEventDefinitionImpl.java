...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_ERROR_EVENT_DEFINITION;
...
public class FluxnovaErrorEventDefinitionImpl extends ErrorEventDefinitionImpl implements FluxnovaErrorEventDefinition {

  protected static Attribute<String> camundaExpressionAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaErrorEventDefinition.class, CAMUNDA_ELEMENT_ERROR_EVENT_DEFINITION)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaErrorEventDefinition>() {
        public FluxnovaErrorEventDefinition newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaErrorEventDefinitionImpl(instanceContext);
        }
      });
  ...
  public FluxnovaErrorEventDefinitionImpl(ModelTypeInstanceContext instanceContext) {
