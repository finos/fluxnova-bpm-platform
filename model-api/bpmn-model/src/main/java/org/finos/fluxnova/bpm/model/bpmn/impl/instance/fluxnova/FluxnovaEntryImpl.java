...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_KEY;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_ENTRY;
 ...
 */
public class FluxnovaEntryImpl extends FluxnovaGenericValueElementImpl implements FluxnovaEntry {

  protected static Attribute<String> camundaKeyAttribute;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaEntry.class, CAMUNDA_ELEMENT_ENTRY)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaEntry>() {
        public FluxnovaEntry newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaEntryImpl(instanceContext);
        }
      });
  ...
  public FluxnovaEntryImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public String getFluxnovaKey() {
    return camundaKeyAttribute.getValue(this);
  }

  public void setFluxnovaKey(String camundaKey) {
