...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_VALIDATION;
 ...
 */
public class FluxnovaValidationImpl extends BpmnModelElementInstanceImpl implements FluxnovaValidation {

  protected static ChildElementCollection<FluxnovaConstraint> camundaConstraintCollection;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaValidation.class, CAMUNDA_ELEMENT_VALIDATION)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaValidation>() {
        public FluxnovaValidation newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaValidationImpl(instanceContext);
        }
      });

    SequenceBuilder sequenceBuilder = typeBuilder.sequence();

    camundaConstraintCollection = sequenceBuilder.elementCollection(FluxnovaConstraint.class)
      .build();

    typeBuilder.build();
  }

  public FluxnovaValidationImpl(ModelTypeInstanceContext instanceContext) {
    super(instanceContext);
  }

  public Collection<FluxnovaConstraint> getFluxnovaConstraints() {
