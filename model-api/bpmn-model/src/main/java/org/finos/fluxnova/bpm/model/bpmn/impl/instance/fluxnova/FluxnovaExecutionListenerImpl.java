...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_EXECUTION_LISTENER;
 ...
 */
public class FluxnovaExecutionListenerImpl extends BpmnModelElementInstanceImpl implements FluxnovaExecutionListener {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaExecutionListener.class, CAMUNDA_ELEMENT_EXECUTION_LISTENER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaExecutionListener>() {
        public FluxnovaExecutionListener newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaExecutionListenerImpl(instanceContext);
        }
      });
  ...
  public FluxnovaExecutionListenerImpl(ModelTypeInstanceContext instanceContext) {
