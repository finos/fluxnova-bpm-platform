...
public abstract class AbstractSignalEventDefinitionBuilder<B extends AbstractSignalEventDefinitionBuilder<B>> extends AbstractRootElementBuilder<B, SignalEventDefinition> {
   ...
   */
  public B fluxnovaInSourceTarget(String source, String target) {
   ...
   * @return the builder object
   */
  public B fluxnovaInSourceExpressionTarget(String sourceExpression, String target) {
    FluxnovaIn param = modelInstance.newInstance(FluxnovaIn.class);

    param.setFluxnovaSourceExpression(sourceExpression);
    param.setFluxnovaTarget(target);
   ...
   * @return the builder object
   */
  public B fluxnovaInAllVariables(String variables, boolean local) {
    FluxnovaIn param = modelInstance.newInstance(FluxnovaIn.class);

    param.setFluxnovaVariables(variables);

    if (local) {
      param.setFluxnovaLocal(local);
    }
   ...
   * @return the builder object
   */
  public B fluxnovaInAllVariables(String variables) {
    return fluxnovaInAllVariables(variables, false);
  }
}
