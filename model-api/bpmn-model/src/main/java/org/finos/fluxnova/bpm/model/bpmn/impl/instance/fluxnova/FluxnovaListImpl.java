...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_LIST;
 ...
 */
public class FluxnovaListImpl extends BpmnModelElementInstanceImpl implements FluxnovaList {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaList.class, CAMUNDA_ELEMENT_LIST)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaList>() {
        public FluxnovaList newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaListImpl(instanceContext);
        }
      });
  ...
  public FluxnovaListImpl(ModelTypeInstanceContext instanceContext) {
