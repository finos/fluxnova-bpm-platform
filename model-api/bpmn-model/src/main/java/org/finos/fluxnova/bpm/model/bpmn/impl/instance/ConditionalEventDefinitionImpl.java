...
import org.finos.fluxnova.bpm.model.bpmn.instance.Condition;
...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_CONDITIONAL_EVENT_DEFINITION;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VARIABLE_NAME;
...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VARIABLE_EVENTS;
...
public class ConditionalEventDefinitionImpl extends EventDefinitionImpl implements ConditionalEventDefinition {
  ...
  @Override
  public String getFluxnovaVariableName() {
    return camundaVariableName.getValue(this);
  }

  @Override
  public void setFluxnovaVariableName(String variableName) {
    camundaVariableName.setValue(this, variableName);
  }

  @Override
  public String getFluxnovaVariableEvents() {
    return camundaVariableEvents.getValue(this);
  }

  @Override
  public void setFluxnovaVariableEvents(String variableEvents) {
    camundaVariableEvents.setValue(this, variableEvents);
  }

  @Override
  public List<String> getFluxnovaVariableEventsList() {
    String variableEvents = camundaVariableEvents.getValue(this);
    return StringUtil.splitCommaSeparatedList(variableEvents);
  }

  @Override
  public void setFluxnovaVariableEventsList(List<String> variableEventsList) {
