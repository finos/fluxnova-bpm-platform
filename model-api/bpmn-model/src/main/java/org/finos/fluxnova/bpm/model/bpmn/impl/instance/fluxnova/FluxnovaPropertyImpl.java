 ...
 */
public class FluxnovaPropertyImpl extends BpmnModelElementInstanceImpl implements FluxnovaProperty {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaProperty.class, CAMUNDA_ELEMENT_PROPERTY)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaProperty>() {
        public FluxnovaProperty newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaPropertyImpl(instanceContext);
        }
      });
  ...
  public FluxnovaPropertyImpl(ModelTypeInstanceContext instanceContext) {
  ...
  public String getFluxnovaValue() {
    return camundaValueAttribute.getValue(this);
  }

  public void setFluxnovaValue(String camundaValue) {
