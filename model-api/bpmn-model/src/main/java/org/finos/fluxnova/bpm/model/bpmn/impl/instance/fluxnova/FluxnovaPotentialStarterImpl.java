...
import org.finos.fluxnova.bpm.model.bpmn.instance.ResourceAssignmentExpression;
...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_POTENTIAL_STARTER;
 ...
 */
public class FluxnovaPotentialStarterImpl extends BpmnModelElementInstanceImpl implements FluxnovaPotentialStarter {

  protected static ChildElement<ResourceAssignmentExpression> resourceAssignmentExpressionChild;

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaPotentialStarter.class, CAMUNDA_ELEMENT_POTENTIAL_STARTER)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaPotentialStarter>() {
        public FluxnovaPotentialStarter newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaPotentialStarterImpl(instanceContext);
        }
      });
  ...
  public FluxnovaPotentialStarterImpl(ModelTypeInstanceContext instanceContext) {
