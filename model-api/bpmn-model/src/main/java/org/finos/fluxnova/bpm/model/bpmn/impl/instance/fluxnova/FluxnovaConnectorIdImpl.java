...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ELEMENT_CONNECTOR_ID;
 ...
 */
public class FluxnovaConnectorIdImpl extends BpmnModelElementInstanceImpl implements FluxnovaConnectorId {

  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaConnectorId.class, CAMUNDA_ELEMENT_CONNECTOR_ID)
      .namespaceUri(CAMUNDA_NS)
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaConnectorId>() {
        public FluxnovaConnectorId newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaConnectorIdImpl(instanceContext);
        }
      });
  ...
  public FluxnovaConnectorIdImpl(ModelTypeInstanceContext instanceContext) {
