...
public class AbstractMultiInstanceLoopCharacteristicsBuilder<B extends AbstractMultiInstanceLoopCharacteristicsBuilder<B>>
   ...
   * @return the builder object
   */
  public B fluxnovaCollection(String expression) {
    element.setFluxnovaCollection(expression);
   ...
   * @return the builder object
   */
  public B fluxnovaElementVariable(String variableName) {
    element.setFluxnovaElementVariable(variableName);
