...
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_BEHAVIOR;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_IS_SEQUENTIAL;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_MULTI_INSTANCE_LOOP_CHARACTERISTICS;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_NONE_BEHAVIOR_EVENT_REF;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_ONE_BEHAVIOR_EVENT_REF;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ASYNC_AFTER;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ASYNC_BEFORE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_EXCLUSIVE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_COLLECTION;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ELEMENT_VARIABLE;
import static org.finos.fluxnova.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;

import java.util.Collection;

import org.finos.fluxnova.bpm.model.bpmn.BpmnModelInstance;
import org.finos.fluxnova.bpm.model.bpmn.MultiInstanceFlowCondition;
import org.finos.fluxnova.bpm.model.bpmn.builder.MultiInstanceLoopCharacteristicsBuilder;
import org.finos.fluxnova.bpm.model.bpmn.instance.CompletionCondition;
import org.finos.fluxnova.bpm.model.bpmn.instance.ComplexBehaviorDefinition;
import org.finos.fluxnova.bpm.model.bpmn.instance.DataInput;
import org.finos.fluxnova.bpm.model.bpmn.instance.DataOutput;
import org.finos.fluxnova.bpm.model.bpmn.instance.EventDefinition;
import org.finos.fluxnova.bpm.model.bpmn.instance.InputDataItem;
import org.finos.fluxnova.bpm.model.bpmn.instance.LoopCardinality;
import org.finos.fluxnova.bpm.model.bpmn.instance.LoopCharacteristics;
import org.finos.fluxnova.bpm.model.bpmn.instance.MultiInstanceLoopCharacteristics;
import org.finos.fluxnova.bpm.model.bpmn.instance.OutputDataItem;
...
import org.finos.fluxnova.bpm.model.xml.type.reference.ElementReference;
...
public class MultiInstanceLoopCharacteristicsImpl extends LoopCharacteristicsImpl implements MultiInstanceLoopCharacteristics {
  ...
  public String getFluxnovaCollection() {
    return camundaCollection.getValue(this);
  }

  public void setFluxnovaCollection(String expression) {
    camundaCollection.setValue(this, expression);
  }

  public String getFluxnovaElementVariable() {
    return camundaElementVariable.getValue(this);
  }

  public void setFluxnovaElementVariable(String variableName) {
