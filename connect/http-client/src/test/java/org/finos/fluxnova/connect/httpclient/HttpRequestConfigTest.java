...
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.AUTHENTICATION_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.CIRCULAR_REDIRECTS_ALLOWED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.CONNECTION_REQUEST_TIMEOUT;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.CONNECTION_TIMEOUT;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.CONTENT_COMPRESSION_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.COOKIE_SPEC;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.DECOMPRESSION_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.EXPECT_CONTINUE_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.LOCAL_ADDRESS;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.MAX_REDIRECTS;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.NORMALIZE_URI;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.PROXY;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.PROXY_PREFERRED_AUTH_SCHEMES;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.REDIRECTS_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.RELATIVE_REDIRECTS_ALLOWED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.SOCKET_TIMEOUT;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.STALE_CONNECTION_CHECK_ENABLED;
import static org.finos.fluxnova.connect.httpclient.impl.RequestConfigOption.TARGET_PREFERRED_AUTH_SCHEMES;
