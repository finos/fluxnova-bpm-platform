 ...
 */
package org.finos.fluxnova.bpm.admin.impl;

import org.finos.fluxnova.bpm.admin.AdminRuntimeDelegate;
import org.finos.fluxnova.bpm.admin.plugin.spi.AdminPlugin;
import org.finos.fluxnova.bpm.webapp.db.CommandExecutor;
import org.finos.fluxnova.bpm.webapp.db.QueryService;
import org.finos.fluxnova.bpm.webapp.impl.db.CommandExecutorImpl;
import org.finos.fluxnova.bpm.webapp.impl.db.QueryServiceImpl;
...
public class DefaultAdminRuntimeDelegate extends AbstractAppRuntimeDelegate<AdminPlugin> implements AdminRuntimeDelegate {
  ...
  private static final List<String> MAPPING_FILES = List.of(
      "org/finos/fluxnova/bpm/admin/plugin/base/queries/metrics.xml"
  );
