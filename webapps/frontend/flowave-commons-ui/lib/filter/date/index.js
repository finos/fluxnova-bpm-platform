...
var moment = require('flowave-bpm-sdk-js/vendor/moment');
...
filtersModule.provider('fwDateFormat', function() {
  var variants = {
    normal: 'LLL',
    short: 'LL',
    long: 'LLLL'
...
filtersModule.config([
  ...
  function($filterProvider) {
    $filterProvider.register('fwDate', [
      '$translate',
      'fwDateFormat',
      function($translate, fwDateFormat) {
        return function(date, variant) {
          ...
          return moment(date, moment.ISO_8601).format(fwDateFormat(variant));
        };
      }
    ]);
  }
