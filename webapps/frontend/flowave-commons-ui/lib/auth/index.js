...
var commonsUtil = require('../util/index'),
  ...
  ifLoggedInDirective = require('./directives/fwIfLoggedIn'),
  ifLoggedOutDirective = require('./directives/fwIfLoggedOut'),
...
ngModule
  ...
  .directive('fwIfLoggedIn', ifLoggedInDirective)
  .directive('fwIfLoggedOut', ifLoggedOutDirective)
