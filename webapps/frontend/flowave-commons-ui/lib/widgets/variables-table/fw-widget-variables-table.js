...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
  ...
  template = require('./fw-widget-variables-table.html?raw'),
  confirmationTemplate = require('./fw-widget-variables-deletion-dialog.html?raw');
      ...
      link: function($scope) {
        ...
        $scope.rowClasses = function(info /*, v*/) {
          return [
            ...
            info.valid ? null : 'ng-invalid-fw-variable-validator'
          ];
        };
              ...
              controller: [
                ...
                function($scope) {
                  $scope.body = $translate.instant(
                    'FW_WIDGET_VARIABLES_TABLE_DIALOGUE',
