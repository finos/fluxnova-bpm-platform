...
var pageUrl = 'http://localhost:' + pkg.gruntConfig.connectPort +
              '/lib/widgets/variables-table/test/fw-widget-variables-table.spec.html';

var page = require('./fw-widget-variables-table.page.js');
...
describe('Variables Table', function() {
  ...
  describe('editing', function() {
    ...
    describe('Null variable', function() {
      ...
      it('has no value input', function() {
        expect(variable.valueText()).to.eventually.eql('FW_WIDGET_VARIABLES_TABLE_NULL');
      });
    });
    ...
    describe('String variable', function() {
      ...
      describe('popup to show long variable', function() {
        ...
        it('has a button to close itself', function() {
          expect(page.modal().button('FW_WIDGET_STRING_DIALOG_LABEL_CLOSE').isDisplayed()).to.eventually.eql(true);
        });

        it('closes when the button is clicked', function() {
          // when
          page.modal().button('FW_WIDGET_STRING_DIALOG_LABEL_CLOSE').click();
  ...
  describe('fw-headers attribute', function() {
    before(function() {
  ...
  describe('fw-editable attribute', function() {
    before(function() {
      browser.get(pageUrl + '#example-2');
  ...
  describe('display', function() {
    ...
    describe('Object', function() {
      ...
      describe('popup to inspect', function() {
        ...
        it('has a button to close itself', function() {
          expect(page.modal().button('FW_WIDGET_VARIABLE_DIALOG_BTN_CLOSE').isDisplayed()).to.eventually.eql(true);
        });


        it('does not have a button to change the serialized value', function() {
          expect(page.modal().button('FW_WIDGET_VARIABLE_DIALOG_BTN_CHANGE').isPresent()).to.eventually.eql(false);
        });


        it('closes when the button is clicked', function() {
          // when
          page.modal().button('FW_WIDGET_VARIABLE_DIALOG_BTN_CLOSE').click();
