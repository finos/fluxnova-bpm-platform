...
var debugDefinition = require('../fw-widget-debug');

var debugModule = angular.module('debugModule', []);
debugModule.directive('fwWidgetDebug', debugDefinition);

var clipboardWidget = require('../../clipboard/fw-widget-clipboard');
debugModule.directive('fwWidgetClipboard', clipboardWidget);
