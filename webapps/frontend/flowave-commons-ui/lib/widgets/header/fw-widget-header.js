...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
  template = require('./fw-widget-header.html?raw'),
  ...
  return {
    ...
    compile: function(el, attrs) {
      if (!attrs.toggleNavigation) {
        attrs.toggleNavigation = 'FW_WIDGET_HEADER_TOGGLE_NAVIGATION';
      }
      if (!attrs.myProfile) {
        attrs.myProfile = 'FW_WIDGET_HEADER_MY_PROFILE';
      }
      if (!attrs.signOut) {
        attrs.signOut = 'FW_WIDGET_HEADER_SIGN_OUT';
      }
      if (!attrs.smallScreenWarning) {
        attrs.smallScreenWarning = 'FW_WIDGET_HEADER_SMALL_SCREEN_WARNING';
      }
    },
