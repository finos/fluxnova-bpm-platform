...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
  template = require('./fw-widget-password.html?raw');

module.exports = [
  'fwAPI',
  'debounce',
  '$timeout',
  function(fwAPI, debounce, $timeout) {
    return {
      scope: {
        profile: '=fwWidgetPasswordProfile',
        password: '=fwWidgetPasswordPassword',
        isValid: '=?fwWidgetPasswordValid'
      },

      link: function($scope) {
        var passwordPolicyProvider = fwAPI.resource('password-policy');
