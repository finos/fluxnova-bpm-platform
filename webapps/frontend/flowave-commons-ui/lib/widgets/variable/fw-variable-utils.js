...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
  typeUtils = require('flowave-bpm-sdk-js/lib/forms/type-util'),
  templateDialog = require('./fw-widget-variable-dialog.html?raw'),
  templateStringDialog = require('./fw-widget-string-dialog.html?raw');
