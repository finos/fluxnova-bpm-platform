...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
    variableDefinition = require('../fw-widget-variable'),
    variableValidator = require('../fw-variable-validator');
...
variableModule.directive('fwVariableValidator', variableValidator);
