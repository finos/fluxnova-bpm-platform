...
var SearchPill = require('../../search-pill/test/fw-widget-search-pill-object.page.js');
...
Example.prototype.searchInput = function() {
  return this.node.element(by.css('[fw-widget-search] [ng-model="inputQuery"]'));
};

Example.prototype.inputDropdown = function() {
  return this.node.element(by.css('[fw-widget-search] .form-container > ul'));
};

Example.prototype.inputDropdownOption = function(option) {
  return this.node.all(by.css('[fw-widget-search] .form-container > ul > li')).get(option);
};

Example.prototype.inputDropdownOptionCount = function() {
  return this.node.all(by.css('[fw-widget-search] .form-container > ul > li')).count();
};
...
Example.prototype.searchPills = function() {
  return this.node.all(by.css('[fw-widget-search] [fw-widget-search-pill]'));
};
