...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
  copy = angular.copy,
  $ = require('jquery'),
  template = require('./fw-widget-search.html?raw');
...
module.exports = [
  ...
  function($timeout, $location, searchService, widgetLocalConf, $translate) {
    ...
    return {
      ...
      scope: {
        types: '=fwWidgetSearchTypes',
        translations: '=fwWidgetSearchTranslations',
        operators: '=fwWidgetSearchOperators',
        searches: '=?fwWidgetSearchSearches',
        validSearches: '=?fwWidgetSearchValidSearches',
        storageGroup: '=?fwWidgetSearchStorageGroup',
        searchId: '@fwWidgetSearchId',
        total: '=?fwWidgetSearchTotal',
        matchAny: '=?fwWidgetSearchMatchAny',
        disableTypeaheadAutoselect: '=?fwWidgetSearchDisableTypeaheadAutoselect'
      },
