...
var angular = require('flowave-bpm-sdk-js/vendor/angular'),
    fs = require('fs'),
    moment = require('flowave-bpm-sdk-js/vendor/moment'),
    data = {},
    chartLineDefinition = require('../fw-widget-chart-line');
...
chartLineModule.directive('fwWidgetChartLine', chartLineDefinition);
