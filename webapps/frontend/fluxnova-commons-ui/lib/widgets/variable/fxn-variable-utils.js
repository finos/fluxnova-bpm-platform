...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  typeUtils = require('fluxnova-bpm-sdk-js/lib/forms/type-util'),
  templateDialog = require('./fxn-widget-variable-dialog.html?raw'),
  templateStringDialog = require('./fxn-widget-string-dialog.html?raw');

var varUtils = {};

function fluxnovaFormattedDate(date) {
  date = date || new Date();
  return date.toISOString().slice(0, -5);
}
varUtils.fluxnovaFormattedDate = fluxnovaFormattedDate;
