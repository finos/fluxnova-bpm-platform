...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  ...
  template = require('./fxn-widget-variables-table.html?raw'),
  confirmationTemplate = require('./fxn-widget-variables-deletion-dialog.html?raw');
...
module.exports = [
  ...
  function($modal, $translate, $document) {
    return {
      ...
      scope: {
        variables: '=?fxnVariables',
        headers: '=?fxnHeaders',
        editable: '=?fxnEditable',
        validatable: '@',
      ...
      link: function($scope) {
        ...
        $scope.downloadLink = angular.isFunction($scope.downloadVar)
          ...
          : function(info) {
              return (
                '/fluxnova/api/engine/engine/default/variable-instance/' +
                info.variable.id +
                '/data'
              );
            };
        ...
        $scope.rowClasses = function(info /*, v*/) {
          return [
            ...
            info.valid ? null : 'ng-invalid-fxn-variable-validator'
          ];
        };
              ...
              controller: [
                ...
                function($scope) {
                  $scope.body = $translate.instant(
                    'FXN_WIDGET_VARIABLES_TABLE_DIALOGUE',
