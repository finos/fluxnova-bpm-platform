...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  template = require('./fxn-widget-password.html?raw');

module.exports = [
  'fxnAPI',
  'debounce',
  '$timeout',
  function(fxnAPI, debounce, $timeout) {
    return {
      scope: {
        profile: '=fxnWidgetPasswordProfile',
        password: '=fxnWidgetPasswordPassword',
        isValid: '=?fxnWidgetPasswordValid'
      },

      link: function($scope) {
        var passwordPolicyProvider = fxnAPI.resource('password-policy');
