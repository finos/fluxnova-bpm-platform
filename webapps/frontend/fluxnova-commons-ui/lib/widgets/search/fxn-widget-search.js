...
var angular = require('fluxnova-bpm-sdk-js/vendor/angular'),
  copy = angular.copy,
  $ = require('jquery'),
  template = require('./fxn-widget-search.html?raw');
...
module.exports = [
  ...
  function($timeout, $location, searchService, widgetLocalConf, $translate) {
    ...
    return {
      ...
      scope: {
        types: '=fxnWidgetSearchTypes',
        translations: '=fxnWidgetSearchTranslations',
        operators: '=fxnWidgetSearchOperators',
        searches: '=?fxnWidgetSearchSearches',
        validSearches: '=?fxnWidgetSearchValidSearches',
        storageGroup: '=?fxnWidgetSearchStorageGroup',
        searchId: '@fxnWidgetSearchId',
        total: '=?fxnWidgetSearchTotal',
        matchAny: '=?fxnWidgetSearchMatchAny',
        disableTypeaheadAutoselect:
          '=?fxnWidgetSearchDisableTypeaheadAutoselect'
      },
