...
var commonsUtil = require('../util/index'),
  ...
  ifLoggedInDirective = require('./directives/fxnIfLoggedIn'),
  ifLoggedOutDirective = require('./directives/fxnIfLoggedOut'),
...
var ngModule = angular.module('fxn.commons.auth', [
  angular.module('ngRoute').name,
  commonsUtil.name,
  'pascalprecht.translate',
  'webapps.plugin',
  'fluxnova.common.services'
]);
...
ngModule
  ...
  .directive('fxnIfLoggedIn', ifLoggedInDirective)
  .directive('fxnIfLoggedOut', ifLoggedOutDirective)
