...
describe('The SDK core', function() {
  ...
  var FwSDK, fwClient, ProcessDefinition, processDefinition;

  it('does not blow when loading', function() {
    expect(function() {
      FwSDK = require('./../../lib/index');
    }).not.to.throw();
  });
  ...
  it('uses the mock HttpClient', function(done) {
    expect(function() {
      ProcessDefinition = fwClient.resource('process-definition');
    }).not.to.throw();
...
describe('The custom configured SDK core', function() {
  ...
  var FwSDK, fwClient, ProcessDefinition;
