...
describe('The select field', function() {
  ...
  var VariableManager = FwSDK.Form.VariableManager;
  var ChoicesFieldHandler = FwSDK.Form.fields.ChoicesFieldHandler;
  var selectTemplate = '<select />';


  function varElement() {
    return $(selectTemplate)
      .attr('fw-variable-name', exampleVariableName)
      .attr('fw-variable-type', 'String')
  ...
  it('should init the var name', function() {
    ...
    // a select box with 'fw-variable-name' directive
    var element = $(selectTemplate).attr('fw-variable-name', exampleVariableName);
  ...
  it('should init the var type', function() {
    ...
    // a select box with 'fw-variable-name' and 'fw-variable-type' directive
  ...
  it('should init the variable value', function() {
    ...
    // an input field with 'fw-variable-name' and 'fw-variable-type' directive and an initial value
  ...
  // option handling (fw-choices) ////////////////////////

  it('should fetch fw-choices list', function() {
    ...
    var element = $(selectTemplate)
      .attr('fw-variable-name', exampleVariableName)
      .attr('fw-variable-type', 'String')
      .attr('fw-choices', exampleChoicesVariableName);
    // with no option selected
    element[0].selectedIndex = -1;
  ...
  it('should fetch fw-choices string map', function() {
  ...
  it('should fetch fw-choices integer map', function() {
