...
describe('The input field', function() {
  ...
  var InputFieldHandler = FwSDK.Form.fields.InputFieldHandler;
  ...
  it('should init the var name', function() {
    ...
    // an input field with 'fw-variable-name' directive
    var element = $(inputFieldTemplate).attr('fw-variable-name', exampleVariableName);
  ...
  it('should init the var type', function() {
    ...
    // an input field with 'fw-variable-name' and 'fw-variable-type' directive
