...
var isBooleanCheckbox = function(element) {
  return (
    ...
    element.attr(constants.DIRECTIVE_FW_VARIABLE_TYPE) === 'Boolean'
  );
};
...
var InputFieldHandler = AbstractFormField.extend(
  /** @lends FwSDK.form.InputFieldHandler.prototype */
  {
    /**
     ...
     *
     * @return {FwSDK.form.InputFieldHandler} Chainable method
     */
    applyValue: function() {
  ...
  /** @lends FwSDK.form.InputFieldHandler */
  {
    selector:
      'input[' +
      constants.DIRECTIVE_FW_VARIABLE_NAME +
