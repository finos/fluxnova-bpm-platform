 ...
 * @class
 * @memberof FwSDK.form
 * @augments {FwSDK.form.AbstractFormField}
 */
var ChoicesFieldHandler = AbstractFormField.extend(
  /** @lends FwSDK.form.ChoicesFieldHandler.prototype */
  {
    /**
     ...
     *
     * @return {FwSDK.form.ChoicesFieldHandler} Chainable method.
     */
    applyValue: function() {
      var selectedIndex = this.element[0].selectedIndex;
      // if fw-choices variable is defined, apply options
      ...
      // select option referenced in fw-variable-name (if any)
      ...
      if (variableValue !== this.previousValue) {
        ...
        this.element.trigger('fwFormVariableApplied', variableValue);
  ...
  /** @lends FwSDK.form.ChoicesFieldHandler */
  {
    selector: 'select[' + constants.DIRECTIVE_FW_VARIABLE_NAME + ']'
  }
);
