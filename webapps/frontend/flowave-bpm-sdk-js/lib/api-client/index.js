 ...
 * @namespace FwSDK.client
 */

/**
 * For the resources implementations
 * @namespace FwSDK.client.resource
 */
...
function FlowaveClient(config) {
  ...
  this.HttpClient = config.HttpClient || FlowaveClient.HttpClient;
 ...
 * @memberof FwSDK.client.FlowaveClient
 * @name HttpClient
 * @type {FwSDK.client.HttpClient}
 */
FlowaveClient.HttpClient = require('./http-client');

// provide an isolated scope
(function(proto) {
  /**
   * configuration storage
   * @memberof FwSDK.client.FlowaveClient.prototype
   * @name  config
   * @type {Object}
   */
  proto.config = {};
   ...
   *
   * @param  {String} name
   * @return {FwSDK.client.AbstractClientResource}
   */
  proto.resource = function(name) {
    return _resources[name];
  };
})(FlowaveClient.prototype);

module.exports = FlowaveClient;
 ...
 * @param {?Object} error
 * @param {FwSDK.AbstractClientResource|FwSDK.AbstractClientResource[]} [results]
 */
