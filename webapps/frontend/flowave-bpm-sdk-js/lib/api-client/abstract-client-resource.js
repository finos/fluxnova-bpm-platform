 ...
 *
 * @class
 * @augments {FwSDK.BaseClass}
 * @memberof FwSDK.client
 *
 * @borrows FwSDK.Events.on                        as on
 * @borrows FwSDK.Events.once                      as once
 * @borrows FwSDK.Events.off                       as off
 * @borrows FwSDK.Events.trigger                   as trigger
 *
 * @borrows FwSDK.Events.on                        as prototype.on
 * @borrows FwSDK.Events.once                      as prototype.once
 * @borrows FwSDK.Events.off                       as prototype.off
 * @borrows FwSDK.Events.trigger                   as prototype.trigger
 *
 *
 * @example
 *
...
var AbstractClientResource = BaseClass.extend(
  ...
  /** @lends AbstractClientResource */
  {
     ...
     *
     * @abstract
     * @memberOf FwSDK.client.AbstractClientResource
     */
    path: '',
     ...
     * @memberof FwSDK.client.AbstractClientResource
     *
     * @fires FwSDK.AbstractClientResource#error
     * @fires FwSDK.AbstractClientResource#loaded
     *
    ...
    count: function(params, done) {
      ...
      this.http.get(this.path + '/count', {
        data: params,
          ...
          if (err) {
            /**
             * @event FwSDK.AbstractClientResource#error
             * @type {Error}
             */
            self.trigger('error', err);
     ...
     *
     * @abstract
     * @memberof FwSDK.AbstractClientResource
     *
