 ...
 * @class
 * @memberof FwSDK.client.resource
 * @augments FwSDK.client.AbstractClientResource
 */
var ProcessDefinition = AbstractClientResource.extend(
  /** @lends  FwSDK.client.resource.ProcessDefinition.prototype */
  {
    /**
  ...
  /** @lends  FwSDK.client.resource.ProcessDefinition */
  {
    /**
     ...
     *
     * @example
     * FwSDK.resource('process-definition').list({
     *   nameLike: 'Process'
