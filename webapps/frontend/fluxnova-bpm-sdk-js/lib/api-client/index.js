 ...
 * @namespace FxnSDK.client
 */

/**
 * For the resources implementations
 * @namespace FxnSDK.client.resource
 */
 ...
 */
function FluxnovaClient(config) {
  if (!config) {
  ...
  this.HttpClient = config.HttpClient || FluxnovaClient.HttpClient;
 ...
 * @memberof FxnSDK.client.FluxnovaClient
 * @name HttpClient
 * @type {FxnSDK.client.HttpClient}
 */
FluxnovaClient.HttpClient = require('./http-client');

// provide an isolated scope
(function(proto) {
  /**
   * configuration storage
   * @memberof FxnSDK.client.FluxnovaClient.prototype
   * @name  config
   * @type {Object}
   */
  proto.config = {};
   ...
   *
   * @param  {String} name
   * @return {FxnSDK.client.AbstractClientResource}
   */
  proto.resource = function(name) {
    return _resources[name];
  };
})(FluxnovaClient.prototype);

module.exports = FluxnovaClient;
 ...
 * @param {?Object} error
 * @param {FxnSDK.AbstractClientResource|FxnSDK.AbstractClientResource[]} [results]
 */
