 ...
 *
 * @class
 * @augments {FxnSDK.BaseClass}
 * @memberof FxnSDK.client
 *
 * @borrows FxnSDK.Events.on                        as on
 * @borrows FxnSDK.Events.once                      as once
 * @borrows FxnSDK.Events.off                       as off
 * @borrows FxnSDK.Events.trigger                   as trigger
 *
 * @borrows FxnSDK.Events.on                        as prototype.on
 * @borrows FxnSDK.Events.once                      as prototype.once
 * @borrows FxnSDK.Events.off                       as prototype.off
 * @borrows FxnSDK.Events.trigger                   as prototype.trigger
 *
 *
 * @example
 *
...
var AbstractClientResource = BaseClass.extend(
  ...
  /** @lends AbstractClientResource */
  {
     ...
     *
     * @abstract
     * @memberOf FxnSDK.client.AbstractClientResource
     */
    path: '',
     ...
     * @memberof FxnSDK.client.AbstractClientResource
     *
     * @fires FxnSDK.AbstractClientResource#error
     * @fires FxnSDK.AbstractClientResource#loaded
     *
    ...
    count: function(params, done) {
      ...
      this.http.get(this.path + '/count', {
        data: params,
          ...
          if (err) {
            /**
             * @event FxnSDK.AbstractClientResource#error
             * @type {Error}
             */
            self.trigger('error', err);
     ...
     *
     * @abstract
     * @memberof FxnSDK.AbstractClientResource
     *
