...
var ErrorButtonHandler = AbstractFormField.extend(
  {
     ...
     */
    initialize: function() {
      this.errorCode = this.element.attr(constants.DIRECTIVE_FXN_ERROR_CODE);
      this.errorMessage = this.element.attr(
        constants.DIRECTIVE_FXN_ERROR_MESSAGE
      );
    },
  ...
  {
    selector: 'button[' + constants.DIRECTIVE_FXN_ERROR_CODE + ']'
  }
);
