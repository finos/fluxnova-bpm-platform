...
var isBooleanCheckbox = function(element) {
  return (
    ...
    element.attr(constants.DIRECTIVE_FXN_VARIABLE_TYPE) === 'Boolean'
  );
};
...
var InputFieldHandler = AbstractFormField.extend(
  /** @lends FxnSDK.form.InputFieldHandler.prototype */
  {
    /**
     ...
     *
     * @return {FxnSDK.form.InputFieldHandler} Chainable method
     */
    applyValue: function() {
  ...
  /** @lends FxnSDK.form.InputFieldHandler */
  {
    selector:
      'input[' +
      constants.DIRECTIVE_FXN_VARIABLE_NAME +
