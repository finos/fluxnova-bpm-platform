...
var $ = (window.jQuery = window.$ = require('jquery')),
  ...
  fwCommonsUi = require('flowave-commons-ui/lib'),
  sdk = require('flowave-bpm-sdk-js/lib/angularjs/index'),
  angular = require('flowave-commons-ui/vendor/angular'),
  fwCommon = require('../../../common/scripts/module'),
  lodash = require('flowave-commons-ui/vendor/lodash'),
  moment = require('flowave-commons-ui/vendor/moment');
...
export function init(pluginDependencies) {
  ...
  appNgModule.provider(
    'configuration',
    require('./../../../common/scripts/services/fw-configuration')(
      window.fwAdminConf,
      'Admin'
    )
  );
  ...
  appNgModule.controller('fwAdminAppCtrl', [
    '$scope',
    '$route',
    'fwAPI',
    function($scope, $route, fwAPI) {
...
export function exposePackages(requirePackages) {
  ...
  requirePackages['flowave-commons-ui'] = fwCommonsUi;
  requirePackages['flowave-bpm-sdk-js'] = sdk;
  requirePackages['fw-common'] = fwCommon;
