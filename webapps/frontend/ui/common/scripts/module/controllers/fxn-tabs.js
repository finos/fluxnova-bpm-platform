...
module.exports = ['$scope', 'search', 'Views', FxnTabs];

function FxnTabs($scope, search, Views) {
...
FxnTabs.prototype.initializeVars = function($scope) {
...
FxnTabs.prototype.getProviders = function(Views, $scope) {
...
FxnTabs.prototype.onLocationChange = function() {
...
FxnTabs.prototype.isTabSelectionChangedInUrl = function(params) {
  return (
...
FxnTabs.prototype.selectTab = function(tabProvider) {
  var params = this.search();
  var tabParams = {
    tab: tabProvider.id
  };
...
FxnTabs.prototype.isSelected = function(tabProvider) {
