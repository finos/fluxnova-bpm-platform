...
module.exports = ['$scope', 'search', 'Views', FwTabs];

function FwTabs($scope, search, Views) {
...
FwTabs.prototype.initializeVars = function($scope) {
...
FwTabs.prototype.getProviders = function(Views, $scope) {
...
FwTabs.prototype.onLocationChange = function() {
...
FwTabs.prototype.isTabSelectionChangedInUrl = function(params) {
  return (
...
FwTabs.prototype.selectTab = function(tabProvider) {
  var params = this.search();
  var tabParams = {
    tab: tabProvider.id
  };
...
FwTabs.prototype.isSelected = function(tabProvider) {
