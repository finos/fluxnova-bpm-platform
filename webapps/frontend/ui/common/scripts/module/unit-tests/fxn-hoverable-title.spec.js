...
var directiveFactory = require('../directives/fxn-hoverable-title');

describe('fxn-common fxn-hoverable-title', function() {
  var linkFn;
  var $element;
  var title;
  var $attr;
  ...
  it('should observe fxn-hoverable-title attribute', function() {
    expect($attr.$observe.calledWith('fxnHoverableTitle')).to.eql(true);
  });
