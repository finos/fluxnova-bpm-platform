...
var directiveFactory = require('../directives/fxn-hover-trigger');

describe('fxn-common fxn-hover-trigger', function() {
  var linkFn;
  var $scope;
  var $element;
  var $attr;
  ...
  describe('on mouseenter event', function() {
    ...
    it('should hover given title', function() {
      expect(HoverArea.hoverTitle.calledWith($attr.fxnHoverTrigger)).to.eql(
        true
      );
    });
  });
