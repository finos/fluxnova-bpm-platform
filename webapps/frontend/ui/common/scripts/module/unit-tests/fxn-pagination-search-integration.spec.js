...
describe('fxn-common FxnPaginationSearchIntegrationController', function() {
  var $rootScope;
  var $q;
  var $scope;
  var search;
  ...
  beforeEach(inject(function($injector) {
    ...
    instance = $controller('FxnPaginationSearchIntegrationController', {
      $scope: $scope,
      search: search,
  ...
  it('should watch global fxn-common:fxn-searchable:query-force-change event', function() {
