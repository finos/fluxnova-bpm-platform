...
var directiveFactory = require('../directives/fw-hover-trigger');

describe('fw-common fw-hover-trigger', function() {
  var linkFn;
  var $scope;
  var $element;
  var $attr;
  ...
  describe('on mouseenter event', function() {
    ...
    it('should hover given title', function() {
      expect(HoverArea.hoverTitle.calledWith($attr.fwHoverTrigger)).to.eql(
        true
      );
    });
  });
