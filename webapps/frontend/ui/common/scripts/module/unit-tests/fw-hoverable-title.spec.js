...
var directiveFactory = require('../directives/fw-hoverable-title');

describe('fw-common fw-hoverable-title', function() {
  var linkFn;
  var $element;
  var title;
  var $attr;
  ...
  it('should observe fw-hoverable-title attribute', function() {
    expect($attr.$observe.calledWith('fwHoverableTitle')).to.eql(true);
  });
