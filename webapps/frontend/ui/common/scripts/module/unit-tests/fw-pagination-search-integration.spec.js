...
describe('fw-common FwPaginationSearchIntegrationController', function() {
  var $rootScope;
  var $q;
  var $scope;
  var search;
  ...
  beforeEach(inject(function($injector) {
    ...
    instance = $controller('FwPaginationSearchIntegrationController', {
      $scope: $scope,
      search: search,
  ...
  it('should watch global fw-common:fw-searchable:query-force-change event', function() {
