...
module.exports = function(config, app) {
  return [
    function() {
      ...
      var values = JSON.parse(storage.getItem('fluxnova-web') || '{}');
      ...
      this.set = function(key, value) {
        values[key] = value;
        storage.setItem('fluxnova-web', JSON.stringify(values));
      };
      ...
      this.clearTranslationData = function() {
        ...
        window.localStorage.setItem('fluxnova-web', JSON.stringify(values));
      };
      ...
      this.getDateLocales = function() {
        return config.fxnDateLocales;
      };

      this.getAppVendor = function() {
        return config.app && config.app.vendor ? config.app.vendor : 'Fluxnova';
      };
