...
// flowave-welcome-bootstrap is copied as-is, so we have to inline everything
...
const loadConfig = (async function() {
  ...
  window.fwWelcomeConf = config;
  return config;
})();

define('flowave-welcome-bootstrap', function() {
  'use strict';
  const bootstrap = config => {
    ...
    var camundaWelcomeUi = require('./flowave-welcome-ui');
...
requirejs(['flowave-welcome-bootstrap'], function() {});
