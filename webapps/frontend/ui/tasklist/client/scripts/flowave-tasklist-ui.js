...
var fwCommon = require('../../../common/scripts/module');
var lodash = require('flowave-commons-ui/vendor/lodash');
...
export function init(pluginDependencies) {
  ...
  tasklistApp.factory(
    'assignNotification',
    require('./services/fw-tasklist-assign-notification')
  );
  tasklistApp.provider(
    'configuration',
    require('./../../../common/scripts/services/fw-configuration')(
      window.fwTasklistConf,
      'Tasklist'
    )
  );
  ...
  tasklistApp.controller(
    'fwTasklistAppCtrl',
    require('./controller/fw-tasklist-app-ctrl')
  );
  tasklistApp.controller(
    'fwTasklistViewCtrl',
    require('./controller/fw-tasklist-view-ctrl')
  );
...
export function exposePackages(container) {
  ...
  container.jquery = $;
  container['flowave-commons-ui'] = commons;
  container['flowave-bpm-sdk-js'] = sdk;
  container['angular-data-depend'] = dataDepend;
  container['fw-common'] = fwCommon;
