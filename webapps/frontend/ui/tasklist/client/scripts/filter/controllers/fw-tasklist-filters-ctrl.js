...
var template = require('./../modals/fw-tasklist-filter-modal.html?raw');
...
module.exports = [
  ...
  'fwAPI',
  '$timeout',
  function($scope, $modal, $q, fwAPI, $timeout) {
    var filtersData = ($scope.filtersData = $scope.tasklistData.newChild(
      $scope
    ));

    var Filter = fwAPI.resource('filter');
