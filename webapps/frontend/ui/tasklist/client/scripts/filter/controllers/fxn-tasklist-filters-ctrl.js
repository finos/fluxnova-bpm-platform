...
var template = require('./../modals/fxn-tasklist-filter-modal.html?raw');
...
module.exports = [
  ...
  'fxnAPI',
  '$timeout',
  function($scope, $modal, $q, fxnAPI, $timeout) {
    var filtersData = ($scope.filtersData = $scope.tasklistData.newChild(
      $scope
    ));

    var Filter = fxnAPI.resource('filter');
