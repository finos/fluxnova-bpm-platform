...
var template = require('./fxn-tasklist-filter-modal-form-permission.html?raw');
...
module.exports = [
  ...
  '$q',
  '$timeout',
  function(fxnAPI, $q, $timeout) {
    return {
      restrict: 'A',
      require: '^fxnTasklistFilterModalForm',
      scope: {
        filter: '=',
        accesses: '=',
        filterModalFormData: '=',
      ...
      link: function($scope, $element, attrs, parentCtrl) {
        ...
        var Authorization = fxnAPI.resource('authorization');
