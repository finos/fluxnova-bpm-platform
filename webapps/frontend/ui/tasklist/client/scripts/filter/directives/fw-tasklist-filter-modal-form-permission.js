...
var template = require('./fw-tasklist-filter-modal-form-permission.html?raw');
...
module.exports = [
  ...
  '$q',
  '$timeout',
  function(fwAPI, $q, $timeout) {
    return {
      restrict: 'A',
      require: '^fwTasklistFilterModalForm',
      scope: {
        filter: '=',
        accesses: '=',
        filterModalFormData: '=',
      ...
      link: function($scope, $element, attrs, parentCtrl) {
        ...
        var Authorization = fwAPI.resource('authorization');
