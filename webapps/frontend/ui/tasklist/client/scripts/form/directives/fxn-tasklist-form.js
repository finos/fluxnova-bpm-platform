...
var template = require('./fxn-tasklist-form.html?raw');

var EMBEDDED_KEY = 'embedded:',
  APP_KEY = 'app:',
  ENGINE_KEY = 'engine:',
  DEPLOYMENT_KEY = 'deployment:',
  FLUXNOVA_FORMS_KEY = 'fluxnova-forms:';
    ...
    controller: [
      ...
      function($scope, Uri) {
        ...
        function parseForm(form) {
          ...
          var key = form.key,
            fluxnovaFormRef = form.fluxnovaFormRef,
          ...
          if (!key && !fluxnovaFormRef) {
            form.type = 'generic';
            return;
          }

          if (fluxnovaFormRef) {
            form.type = 'fluxnova-forms';
          ...
          if (key.indexOf(EMBEDDED_KEY) === 0) {
            ...
            form.type = 'embedded';
          } else if (key.indexOf(FLUXNOVA_FORMS_KEY) === 0) {
            key = key.substring(FLUXNOVA_FORMS_KEY.length);
            form.type = 'fluxnova-forms';
          } else {
            form.type = 'external';
          }
