...
//  flowave-tasklist-bootstrap is copied as-is, so we have to inline everything
...
const loadConfig = (async function() {
  ...
  window.fwTasklistConf = config;
  return config;
})();

define('flowave-tasklist-bootstrap', function() {
  'use strict';
  const bootstrap = config => {
    ...
    var camundaTasklistUi = require('./flowave-tasklist-ui');
...
requirejs(['flowave-tasklist-bootstrap'], function() {});
