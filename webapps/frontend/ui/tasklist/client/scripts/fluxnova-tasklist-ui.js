...
export function init(pluginDependencies) {
  ...
  var tasklistApp = angular.module('fxn.tasklist', ngDeps);
  ...
  tasklistApp.factory(
    'assignNotification',
    require('./services/fxn-tasklist-assign-notification')
  );
  tasklistApp.provider(
    'configuration',
    require('./../../../common/scripts/services/fxn-configuration')(
      window.fxnTasklistConf,
      'Tasklist'
    )
  );
  ...
  tasklistApp.controller(
    'fxnTasklistAppCtrl',
    require('./controller/fxn-tasklist-app-ctrl')
  );
  tasklistApp.controller(
    'fxnTasklistViewCtrl',
    require('./controller/fxn-tasklist-view-ctrl')
  );
