...
var startProcessActionTemplate = require('./fxn-tasklist-navbar-action-start-process-plugin.html?raw');
var template = require('./modals/fxn-tasklist-process-start-modal.html?raw');
...
var Controller = [
  ...
  '$location',
  'search',
  function($scope, $modal, $q, fxnAPI, dataDepend, $location, search) {
    ...
    $scope.open = function(ignoreSearch) {
      ...
      var modalInstance = $modal.open({
        size: 'lg',
        controller: 'fxnProcessStartModalCtrl',
        template: template,
        resolve: {
