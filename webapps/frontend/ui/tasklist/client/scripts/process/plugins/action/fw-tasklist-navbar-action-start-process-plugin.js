...
var startProcessActionTemplate = require('./fw-tasklist-navbar-action-start-process-plugin.html?raw');
var template = require('./modals/fw-tasklist-process-start-modal.html?raw');
...
var Controller = [
  ...
  '$location',
  'search',
  function($scope, $modal, $q, fwAPI, dataDepend, $location, search) {
    var ProcessDefinition = fwAPI.resource('process-definition');
    ...
    $scope.open = function(ignoreSearch) {
      ...
      var modalInstance = $modal.open({
        size: 'lg',
        controller: 'fwProcessStartModalCtrl',
        template: template,
        resolve: {
