...
var template = require('./fxn-tasklist-task-meta.html?raw');
var editGroupsFormTemplate = require('./../modals/fxn-tasklist-groups-modal.html?raw');
...
module.exports = [
  ...
  'fixDate',
  'unfixDate',
  function($modal, $timeout, fxnAPI, fixDate, unfixDate) {
      ...
      link: function($scope, $element) {
        ...
        function saveDate(propName) {
          return function(varValue) {
            ...
            document
              .querySelector(
                '[fxn-widget-inline-field].' + propName.toLowerCase() + '-date'
              )
              .focus();
          };
        }
        ...
        function focusAssignee() {
          var el = document.querySelector(
            '[fxn-tasklist-task-meta] [fxn-widget-inline-field][value="assignee.id"]'
          );
          if (el) {
            el.focus();
          } else {
            el = document.querySelector('[fxn-tasklist-task-meta] .claim');
            if (el) {
              el.focus();
            }
          }
        ...
        function notifyOnCancelEditing(property) {
          return function() {
            ...
            if (property === 'assignee') {
              ...
              el = document.querySelector(
                '[fxn-widget-inline-field].' + property.toLowerCase() + '-date'
              );
            }
            if (el) {
              el.focus();
        ...
        $scope.editGroups = function() {
          ...
          $modal
            .open({
              ...
              controller: 'fxnGroupEditModalCtrl',
              resolve: {
