...
var template = require('./fw-tasklist-task-meta.html?raw');
var editGroupsFormTemplate = require('./../modals/fw-tasklist-groups-modal.html?raw');
...
module.exports = [
  ...
  'fixDate',
  'unfixDate',
  function($modal, $timeout, fwAPI, fixDate, unfixDate) {
      ...
      link: function($scope, $element) {
        ...
        function saveDate(propName) {
          return function(varValue) {
            ...
            document
              .querySelector(
                '[fw-widget-inline-field].' + propName.toLowerCase() + '-date'
              )
              .focus();
          };
        }
        ...
        function focusAssignee() {
          var el = document.querySelector(
            '[fw-tasklist-task-meta] [fw-widget-inline-field][value="assignee.id"]'
          );
          if (el) {
            el.focus();
          } else {
            el = document.querySelector('[fw-tasklist-task-meta] .claim');
            if (el) {
              el.focus();
            }
          }
        ...
        function notifyOnCancelEditing(property) {
          return function() {
            ...
            if (property === 'assignee') {
              ...
              el = document.querySelector(
                '[fw-widget-inline-field].' + property.toLowerCase() + '-date'
              );
            }
            if (el) {
              el.focus();
        ...
        $scope.editGroups = function() {
          ...
          $modal
            .open({
              ...
              controller: 'fwGroupEditModalCtrl',
              resolve: {
