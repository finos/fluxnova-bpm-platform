...
var addCommentTemplate = require('./fw-tasklist-task-action-comment-plugin.html?raw');
var addCommentFormTemplate = require('./modals/fw-tasklist-comment-form.html?raw');
    ...
    $scope.createComment = function() {
      $modal
        .open({
          ...
          controller: 'fwCommentCreateModalCtrl',
          resolve: {
            task: function() {
              return $scope.task;
            }
