...
var addCommentTemplate = require('./fxn-tasklist-task-action-comment-plugin.html?raw');
var addCommentFormTemplate = require('./modals/fxn-tasklist-comment-form.html?raw');
    ...
    $scope.createComment = function() {
      $modal
        .open({
          ...
          controller: 'fxnCommentCreateModalCtrl',
          resolve: {
            task: function() {
              return $scope.task;
            }
