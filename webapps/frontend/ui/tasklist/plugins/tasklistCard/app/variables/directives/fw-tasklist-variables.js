...
var template = require('./fw-tasklist-variables.html?raw');
var modalTemplate = require('./../modals/fw-tasklist-variables-detail-modal.html?raw');
        ...
        scope.showValue = function(variable, $event) {
          ...
          $modal
            .open({
              ...
              controller: 'fwTasklistVariablesDetailsModalCtrl'
            })
