...
var template = require('./fxn-tasklist-variables.html?raw');
var modalTemplate = require('./../modals/fxn-tasklist-variables-detail-modal.html?raw');
        ...
        scope.showValue = function(variable, $event) {
          ...
          $modal
            .open({
              ...
              controller: 'fxnTasklistVariablesDetailsModalCtrl'
            })
