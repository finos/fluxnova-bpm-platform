...
var createTaskActionTemplate = require('./fxn-tasklist-navbar-action-create-task-plugin.html?raw');
var createTaskModalTemplate = require('./modals/fxn-tasklist-create-task-modal.html?raw');
  ...
  function($scope, $modal, $timeout) {
    $scope.open = function() {
      var modalInstance = $modal.open({
        size: 'lg',
        controller: 'fxnCreateTaskModalCtrl',
