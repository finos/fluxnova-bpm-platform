...
//  fluxnova-cockpit-bootstrap is copied as-is, so we have to inline everything
...
const loadConfig = (async function() {
  ...
  window.fxnCockpitConf = config;

  return config;
})();

define('fluxnova-cockpit-bootstrap', function() {
  'use strict';
  const bootstrap = config => {
    ...
    var fluxnovaCockpitUi = require('./fluxnova-cockpit-ui');
    fluxnovaCockpitUi.exposePackages(window);
    ...
    requirejs([`${appRoot}/lib/globalize.js`], function(globalize) {
      ...
      requirejs(dependencies, function(jquery, angular) {
        ...
        if (
          ...
          angular.module('fxn.cockpit.custom', []);
        ...
        function loadRequireJsDeps() {
          ...
          requirejs(custom.deps || [], function() {
            ...
            angular.module('fxn.cockpit.custom', custom.ngDeps);
        ...
        function initCockpitUi(pluginDependencies) {
          ...
          // initialize Cockpit
          fluxnovaCockpitUi.init(pluginDependencies);
        }
      });
    });
  };
...
requirejs(['fluxnova-cockpit-bootstrap'], function() {});
