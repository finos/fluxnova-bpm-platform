...
var template = require('./fw-cockpit-deployments.html?raw');
var searchConfigJSON = require('./fw-cockpit-deployments-search-plugin-config.json');
  ...
  function() {
    return {
      ...
      controller: [
        ...
        'Notifications',
        'fwAPI',
        function($scope, $location, $rootScope, search, Notifications, fwAPI) {
          var Deployment = fwAPI.resource('deployment');
          ...
          deploymentsListData.observe('deploymentsSorting', function(
            ...
            $rootScope.$broadcast('fw-common:fw-searchable:query-force-change');
          });
