...
var deleteDeploymentController = require('../fw-cockpit-delete-deployment-modal-ctrl');
...
describe('cockpit.repository.deployment.action deleteDeployment modal controller', function() {
  ...
  // For now only new features added as part of fw-7534
  ...
  describe('deleteDeployment', () => {
    ...
    it('should perform delete deployment request', () => {
      ...
      expect(
        fwAPI.delete.calledWith(deployment.id, {
          cascade: false,
