...
//  flowave-cockpit-bootstrap is copied as-is, so we have to inline everything
...
const loadConfig = (async function() {
  ...
  window.fwCockpitConf = config;

  return config;
})();

define('flowave-cockpit-bootstrap', function() {
  'use strict';
  const bootstrap = config => {
    ...
    var camundaCockpitUi = require('./flowave-cockpit-ui');
...
requirejs(['flowave-cockpit-bootstrap'], function() {});
