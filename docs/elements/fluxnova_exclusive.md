...
# Slot: fluxnova_exclusive 


_Whether this element participates in an exclusive job execution._
...
URI: [fluxnova_bpm_platform:fluxnova_exclusive](https://w3id.org/TD-Universe/fluxnova-bpm-platform/fluxnova_exclusive)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:fluxnova_exclusive |
| native | fluxnova_bpm_platform:fluxnova_exclusive |
