...
_The BPMN intermediateCatchEvent element_
...
URI: [fluxnova_bpm_platform:IntermediateCatchEvent](https://w3id.org/TD-Universe/fluxnova-bpm-platform/IntermediateCatchEvent)
...
```mermaid
 classDiagram
    class IntermediateCatchEvent
    click IntermediateCatchEvent href "../IntermediateCatchEvent/"
      CatchEvent <|-- IntermediateCatchEvent
        click CatchEvent href "../CatchEvent/"
      
      IntermediateCatchEvent : auditing
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      IntermediateCatchEvent : category_value_refs
        
          
    
        
        
        IntermediateCatchEvent --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      IntermediateCatchEvent : data_output_associations
        
          
    
        
        
        IntermediateCatchEvent --> "*" DataOutputAssociation : data_output_associations
        click DataOutputAssociation href "../DataOutputAssociation/"
    

        
      IntermediateCatchEvent : data_outputs
        
          
    
        
        
        IntermediateCatchEvent --> "*" DataOutput : data_outputs
        click DataOutput href "../DataOutput/"
    

        
      IntermediateCatchEvent : diagram_element
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      IntermediateCatchEvent : documentations
        
          
    
        
        
        IntermediateCatchEvent --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      IntermediateCatchEvent : event_definition_refs
        
          
    
        
        
        IntermediateCatchEvent --> "*" EventDefinition : event_definition_refs
        click EventDefinition href "../EventDefinition/"
    

        
      IntermediateCatchEvent : event_definitions
        
          
    
        
        
        IntermediateCatchEvent --> "*" EventDefinition : event_definitions
        click EventDefinition href "../EventDefinition/"
    

        
      IntermediateCatchEvent : extension_elements
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      IntermediateCatchEvent : fluxnova_async_after
        
      IntermediateCatchEvent : fluxnova_async_before
        
      IntermediateCatchEvent : fluxnova_exclusive
        
      IntermediateCatchEvent : fluxnova_job_priority
        
      IntermediateCatchEvent : id
        
      IntermediateCatchEvent : incoming
        
          
    
        
        
        IntermediateCatchEvent --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      IntermediateCatchEvent : monitoring
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" Monitoring : monitoring
      ...
      IntermediateCatchEvent : outgoing
        
          
    
        
        
        IntermediateCatchEvent --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      IntermediateCatchEvent : output_set
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" OutputSet : output_set
        click OutputSet href "../OutputSet/"
    

        
      IntermediateCatchEvent : parallel_multiple
        
      IntermediateCatchEvent : previous_nodes
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      IntermediateCatchEvent : properties
        
          
    
        
        
        IntermediateCatchEvent --> "*" BpmnProperty : properties
        click BpmnProperty href "../BpmnProperty/"
    

        
      IntermediateCatchEvent : scope
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      IntermediateCatchEvent : succeeding_nodes
        
          
    
        
        
        IntermediateCatchEvent --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/IntermediateCatchEvent.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:IntermediateCatchEvent |
| native | fluxnova_bpm_platform:IntermediateCatchEvent |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/IntermediateCatchEvent.java
description: The BPMN intermediateCatchEvent element
in_subset:
- instance
- fluxnova_bpmn_model
