...
_Variable value stored as text._
...
URI: [fluxnova_bpm_platform:text_value](https://w3id.org/TD-Universe/fluxnova-bpm-platform/text_value)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:text_value |
| native | fluxnova_bpm_platform:text_value |
