...
_Name of the deployed resource file._
...
URI: [fluxnova_bpm_platform:resource_name](https://w3id.org/TD-Universe/fluxnova-bpm-platform/resource_name)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:resource_name |
| native | fluxnova_bpm_platform:resource_name |
