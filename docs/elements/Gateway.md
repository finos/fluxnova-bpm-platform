...
URI: [fluxnova_bpm_platform:Gateway](https://w3id.org/TD-Universe/fluxnova-bpm-platform/Gateway)
 ...
 classDiagram
    ...
    click Gateway href "../Gateway/"
      ...
      Gateway : auditing
        ...
        Gateway --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      Gateway : category_value_refs
        
          
    
        
        
        Gateway --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      Gateway : diagram_element
        
          
    
        
        
        Gateway --> "0..1" DiagramElement : diagram_element
      ...
      Gateway : documentations
        ...
        Gateway --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      Gateway : extension_elements
        
          
    
        
        
        Gateway --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      Gateway : fluxnova_async_after
        
      Gateway : fluxnova_async_before
        
      Gateway : fluxnova_exclusive
        
      Gateway : fluxnova_job_priority
      ...
      Gateway : monitoring
        ...
        Gateway --> "0..1" Monitoring : monitoring
      ...
      Gateway : outgoing
        ...
        Gateway --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      Gateway : previous_nodes
        
          
    
        
        
        Gateway --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
      ...
      Gateway : scope
        ...
        Gateway --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      Gateway : succeeding_nodes
        
          
    
        
        
        Gateway --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
    ...
    * [BaseElement](BaseElement.md)
        * [FlowElement](FlowElement.md)
            * [FlowNode](FlowNode.md)
                * **Gateway**
                    * [ComplexGateway](ComplexGateway.md)
                    * [EventBasedGateway](EventBasedGateway.md)
                    * [ExclusiveGateway](ExclusiveGateway.md)
                    * [InclusiveGateway](InclusiveGateway.md)
                    * [ParallelGateway](ParallelGateway.md)
...
| ---  | --- | --- | --- |
| [gateway_direction](gateway_direction.md) | 0..1 <br/> [String](String.md) | Convergence/divergence direction of token routing through this gateway | direct |
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/Gateway.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:Gateway |
| native | fluxnova_bpm_platform:Gateway |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/Gateway.java
description: The BPMN gateway element
in_subset:
- instance
- fluxnova_bpmn_model
