...
URI: [fluxnova_bpm_platform:CatchEvent](https://w3id.org/TD-Universe/fluxnova-bpm-platform/CatchEvent)
 ...
 classDiagram
    ...
    click CatchEvent href "../CatchEvent/"
      ...
      CatchEvent : auditing
        ...
        CatchEvent --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      CatchEvent : category_value_refs
        
          
    
        
        
        CatchEvent --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      CatchEvent : data_output_associations
        
          
    
        
        
        CatchEvent --> "*" DataOutputAssociation : data_output_associations
        click DataOutputAssociation href "../DataOutputAssociation/"
    

        
      CatchEvent : data_outputs
        
          
    
        
        
        CatchEvent --> "*" DataOutput : data_outputs
        click DataOutput href "../DataOutput/"
    

        
      CatchEvent : diagram_element
        
          
    
        
        
        CatchEvent --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      CatchEvent : documentations
        
          
    
        
        
        CatchEvent --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      CatchEvent : event_definition_refs
        
          
    
        
        
        CatchEvent --> "*" EventDefinition : event_definition_refs
        click EventDefinition href "../EventDefinition/"
    

        
      CatchEvent : event_definitions
        
          
    
        
        
        CatchEvent --> "*" EventDefinition : event_definitions
        click EventDefinition href "../EventDefinition/"
    

        
      CatchEvent : extension_elements
        
          
    
        
        
        CatchEvent --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      CatchEvent : fluxnova_async_after
        
      CatchEvent : fluxnova_async_before
        
      CatchEvent : fluxnova_exclusive
        
      CatchEvent : fluxnova_job_priority
      ...
      CatchEvent : incoming
        ...
        CatchEvent --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      CatchEvent : monitoring
        
          
    
        
        
        CatchEvent --> "0..1" Monitoring : monitoring
      ...
      CatchEvent : outgoing
        ...
        CatchEvent --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      CatchEvent : output_set
        
          
    
        
        
        CatchEvent --> "0..1" OutputSet : output_set
        click OutputSet href "../OutputSet/"
    

        
      CatchEvent : parallel_multiple
        
      CatchEvent : previous_nodes
        
          
    
        
        
        CatchEvent --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      CatchEvent : properties
        
          
    
        
        
        CatchEvent --> "*" BpmnProperty : properties
      ...
      CatchEvent : scope
        ...
        CatchEvent --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      CatchEvent : succeeding_nodes
        
          
    
        
        
        CatchEvent --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
            ...
            * [FlowNode](FlowNode.md)
                * [Event](Event.md) [ [InteractionNode](InteractionNode.md)]
                    * **CatchEvent**
                        ...
                        * [IntermediateCatchEvent](IntermediateCatchEvent.md)
...
| ---  | --- | --- | --- |
| [parallel_multiple](parallel_multiple.md) | 0..1 <br/> [Boolean](Boolean.md) | Whether all event triggers must occur (parallel) rather than any one | direct |
| [data_outputs](data_outputs.md) | * <br/> [DataOutput](DataOutput.md) | Output data elements of this specification | direct |
| [data_output_associations](data_output_associations.md) | * <br/> [DataOutputAssociation](DataOutputAssociation.md) | Data associations that move output data out of this activity | direct |
| [output_set](output_set.md) | 0..1 <br/> [OutputSet](OutputSet.md) | The output set associated with this output data | direct |
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/CatchEvent.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:CatchEvent |
| native | fluxnova_bpm_platform:CatchEvent |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/CatchEvent.java
description: The BPMN catchEvent element
in_subset:
- instance
- fluxnova_bpmn_model
