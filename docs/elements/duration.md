...
URI: [fluxnova_bpm_platform:duration](https://w3id.org/TD-Universe/fluxnova-bpm-platform/duration)
...
| Domain Of | [HistoricScopeInstance](HistoricScopeInstance.md) |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:duration |
| native | fluxnova_bpm_platform:duration |
