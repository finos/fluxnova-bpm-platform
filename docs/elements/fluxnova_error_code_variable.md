...
# Slot: fluxnova_error_code_variable 


_Process variable to receive the error code._
...
URI: [fluxnova_bpm_platform:fluxnova_error_code_variable](https://w3id.org/TD-Universe/fluxnova-bpm-platform/fluxnova_error_code_variable)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:fluxnova_error_code_variable |
| native | fluxnova_bpm_platform:fluxnova_error_code_variable |
