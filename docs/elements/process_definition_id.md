...
# Slot: process_definition_id 


_Reference to the process definition._
...
URI: [fluxnova_bpm_platform:process_definition_id](https://w3id.org/TD-Universe/fluxnova-bpm-platform/process_definition_id)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:process_definition_id |
| native | fluxnova_bpm_platform:process_definition_id |
