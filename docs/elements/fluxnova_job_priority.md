...
# Slot: fluxnova_job_priority 


_Priority assigned to async continuation jobs for this element._
...
URI: [fluxnova_bpm_platform:fluxnova_job_priority](https://w3id.org/TD-Universe/fluxnova-bpm-platform/fluxnova_job_priority)
...
| Domain Of | [FlowNode](FlowNode.md), [Process](Process.md) |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:fluxnova_job_priority |
| native | fluxnova_bpm_platform:fluxnova_job_priority |
