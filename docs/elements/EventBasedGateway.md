...
_The BPMN eventBasedGateway element_
...
URI: [fluxnova_bpm_platform:EventBasedGateway](https://w3id.org/TD-Universe/fluxnova-bpm-platform/EventBasedGateway)
...
```mermaid
 classDiagram
    class EventBasedGateway
    click EventBasedGateway href "../EventBasedGateway/"
      Gateway <|-- EventBasedGateway
        click Gateway href "../Gateway/"
      
      EventBasedGateway : auditing
        
          
    
        
        
        EventBasedGateway --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      EventBasedGateway : category_value_refs
        
          
    
        
        
        EventBasedGateway --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      EventBasedGateway : diagram_element
        
          
    
        
        
        EventBasedGateway --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      EventBasedGateway : documentations
        
          
    
        
        
        EventBasedGateway --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      EventBasedGateway : event_gateway_type
        
      EventBasedGateway : extension_elements
        
          
    
        
        
        EventBasedGateway --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      EventBasedGateway : fluxnova_async_after
        
      EventBasedGateway : fluxnova_async_before
        
      EventBasedGateway : fluxnova_exclusive
        
      EventBasedGateway : fluxnova_job_priority
        
      EventBasedGateway : gateway_direction
        
      EventBasedGateway : id
        
      EventBasedGateway : incoming
        
          
    
        
        
        EventBasedGateway --> "*" SequenceFlow : incoming
      ...
      EventBasedGateway : monitoring
        
          
    
        
        
        EventBasedGateway --> "0..1" Monitoring : monitoring
      ...
      EventBasedGateway : outgoing
        
          
    
        
        
        EventBasedGateway --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      EventBasedGateway : previous_nodes
        
          
    
        
        
        EventBasedGateway --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      EventBasedGateway : scope
        
          
    
        
        
        EventBasedGateway --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      EventBasedGateway : succeeding_nodes
        
          
    
        
        
        EventBasedGateway --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| ---  | --- | --- | --- |
| [instantiate](instantiate.md) | 0..1 <br/> [Boolean](Boolean.md) | Whether receiving this message creates a new process instance | direct |
| [event_gateway_type](event_gateway_type.md) | 0..1 <br/> [String](String.md) | The event gateway type of this element | direct |
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/EventBasedGateway.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:EventBasedGateway |
| native | fluxnova_bpm_platform:EventBasedGateway |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/EventBasedGateway.java
description: The BPMN eventBasedGateway element
in_subset:
- instance
- fluxnova_bpmn_model
...
attributes:
  instantiate:
    name: instantiate
    description: Whether receiving this message creates a new process instance.
    from_schema: https://w3id.org/TD-Universe/fluxnova-bpm-platform
    rank: 1000
    owner: EventBasedGateway
    domain_of:
    - EventBasedGateway
    range: boolean
  event_gateway_type:
    name: event_gateway_type
    description: The event gateway type of this element.
    from_schema: https://w3id.org/TD-Universe/fluxnova-bpm-platform
    rank: 1000
    owner: EventBasedGateway
    domain_of:
