...
_The previous nodes of this element._
...
URI: [fluxnova_bpm_platform:previous_nodes](https://w3id.org/TD-Universe/fluxnova-bpm-platform/previous_nodes)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:previous_nodes |
| native | fluxnova_bpm_platform:previous_nodes |
