...
# Slot: succeeding_nodes 


_The succeeding nodes of this element._
...
URI: [fluxnova_bpm_platform:succeeding_nodes](https://w3id.org/TD-Universe/fluxnova-bpm-platform/succeeding_nodes)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:succeeding_nodes |
| native | fluxnova_bpm_platform:succeeding_nodes |
