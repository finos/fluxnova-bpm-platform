...
# Slot: cause_incident_id 


_Id of the incident on which this incident has been triggered._
...
URI: [fluxnova_bpm_platform:cause_incident_id](https://w3id.org/TD-Universe/fluxnova-bpm-platform/cause_incident_id)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:cause_incident_id |
| native | fluxnova_bpm_platform:cause_incident_id |
