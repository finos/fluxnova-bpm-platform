...
# Slot: super_case_execution_id 


_Reference to the super case execution._
...
URI: [fluxnova_bpm_platform:super_case_execution_id](https://w3id.org/TD-Universe/fluxnova-bpm-platform/super_case_execution_id)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:super_case_execution_id |
| native | fluxnova_bpm_platform:super_case_execution_id |
