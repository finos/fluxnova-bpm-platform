...
_The BPMN inclusiveGateway element_
...
URI: [fluxnova_bpm_platform:InclusiveGateway](https://w3id.org/TD-Universe/fluxnova-bpm-platform/InclusiveGateway)
...
```mermaid
 classDiagram
    class InclusiveGateway
    click InclusiveGateway href "../InclusiveGateway/"
      Gateway <|-- InclusiveGateway
        click Gateway href "../Gateway/"
      
      InclusiveGateway : auditing
        
          
    
        
        
        InclusiveGateway --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      InclusiveGateway : category_value_refs
        
          
    
        
        
        InclusiveGateway --> "*" CategoryValue : category_value_refs
      ...
      InclusiveGateway : default
        ...
        InclusiveGateway --> "0..1" SequenceFlow : default
        click SequenceFlow href "../SequenceFlow/"
    

        
      InclusiveGateway : diagram_element
        
          
    
        
        
        InclusiveGateway --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      InclusiveGateway : documentations
        
          
    
        
        
        InclusiveGateway --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      InclusiveGateway : extension_elements
        
          
    
        
        
        InclusiveGateway --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      InclusiveGateway : fluxnova_async_after
        
      InclusiveGateway : fluxnova_async_before
        
      InclusiveGateway : fluxnova_exclusive
        
      InclusiveGateway : fluxnova_job_priority
        
      InclusiveGateway : gateway_direction
      ...
      InclusiveGateway : incoming
        ...
        InclusiveGateway --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      InclusiveGateway : monitoring
        
          
    
        
        
        InclusiveGateway --> "0..1" Monitoring : monitoring
      ...
      InclusiveGateway : outgoing
        ...
        InclusiveGateway --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      InclusiveGateway : previous_nodes
        
          
    
        
        
        InclusiveGateway --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      InclusiveGateway : scope
        
          
    
        
        
        InclusiveGateway --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      InclusiveGateway : succeeding_nodes
        
          
    
        
        
        InclusiveGateway --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/InclusiveGateway.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:InclusiveGateway |
| native | fluxnova_bpm_platform:InclusiveGateway |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/InclusiveGateway.java
description: The BPMN inclusiveGateway element
in_subset:
- instance
- fluxnova_bpmn_model
