...
URI: [fluxnova_bpm_platform:BpmnTask](https://w3id.org/TD-Universe/fluxnova-bpm-platform/BpmnTask)
...
```mermaid
 classDiagram
    ...
    click BpmnTask href "../BpmnTask/"
      ...
      BpmnTask <|-- ReceiveTask
        click ReceiveTask href "../ReceiveTask/"
      BpmnTask <|-- ScriptTask
        click ScriptTask href "../ScriptTask/"
      BpmnTask <|-- SendTask
      ...
      BpmnTask : auditing
        ...
        BpmnTask --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      BpmnTask : category_value_refs
        
          
    
        
        
        BpmnTask --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      BpmnTask : completion_quantity
        
      BpmnTask : data_input_associations
        
          
    
        
        
        BpmnTask --> "*" DataInputAssociation : data_input_associations
        click DataInputAssociation href "../DataInputAssociation/"
    

        
      BpmnTask : data_output_associations
        
          
    
        
        
        BpmnTask --> "*" DataOutputAssociation : data_output_associations
      ...
      BpmnTask : default
        ...
        BpmnTask --> "0..1" SequenceFlow : default
        click SequenceFlow href "../SequenceFlow/"
    

        
      BpmnTask : diagram_element
        
          
    
        
        
        BpmnTask --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      BpmnTask : documentations
        
          
    
        
        
        BpmnTask --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      BpmnTask : extension_elements
        
          
    
        
        
        BpmnTask --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      BpmnTask : fluxnova_async
        
      BpmnTask : fluxnova_async_after
        
      BpmnTask : fluxnova_async_before
        
      BpmnTask : fluxnova_exclusive
        
      BpmnTask : fluxnova_job_priority
        
      BpmnTask : for_compensation
      ...
      BpmnTask : incoming
        ...
        BpmnTask --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      BpmnTask : io_specification
        
          
    
        
        
        BpmnTask --> "0..1" IoSpecification : io_specification
        click IoSpecification href "../IoSpecification/"
    

        
      BpmnTask : loop_characteristics
        
          
    
        
        
        BpmnTask --> "0..1" LoopCharacteristics : loop_characteristics
      ...
      BpmnTask : monitoring
        ...
        BpmnTask --> "0..1" Monitoring : monitoring
      ...
      BpmnTask : outgoing
        ...
        BpmnTask --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      BpmnTask : previous_nodes
        
          
    
        
        
        BpmnTask --> "0..1" FlowNode : previous_nodes
      ...
      BpmnTask : properties
        ...
        BpmnTask --> "*" BpmnProperty : properties
        click BpmnProperty href "../BpmnProperty/"
    

        
      BpmnTask : resource_roles
        
          
    
        
        
        BpmnTask --> "*" ResourceRole : resource_roles
      ...
      BpmnTask : scope
        ...
        BpmnTask --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      BpmnTask : start_quantity
        
      BpmnTask : succeeding_nodes
        
          
    
        
        
        BpmnTask --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/Task.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:BpmnTask |
| native | fluxnova_bpm_platform:BpmnTask |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/Task.java
description: The BPMN task element
in_subset:
- instance
- fluxnova_bpmn_model
