...
_The BPMN potentialOwner element_
...
URI: [fluxnova_bpm_platform:PotentialOwner](https://w3id.org/TD-Universe/fluxnova-bpm-platform/PotentialOwner)
...
```mermaid
 classDiagram
    ...
    click PotentialOwner href "../PotentialOwner/"
      ...
      PotentialOwner : diagram_element
        
          
    
        
        
        PotentialOwner --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      PotentialOwner : documentations
        
          
    
        
        
        PotentialOwner --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      PotentialOwner : extension_elements
        
          
    
        
        
        PotentialOwner --> "0..1" ExtensionElements : extension_elements
      ...
      PotentialOwner : resource
        
          
    
        
        
        PotentialOwner --> "0..1" Resource : resource
        click Resource href "../Resource/"
    

        
      PotentialOwner : resource_assignment_expression
        
          
    
        
        
        PotentialOwner --> "0..1" ResourceAssignmentExpression : resource_assignment_expression
        click ResourceAssignmentExpression href "../ResourceAssignmentExpression/"
    

        
      PotentialOwner : resource_parameter_binding
        
          
    
        
        
        PotentialOwner --> "*" ResourceParameterBinding : resource_parameter_binding
        click ResourceParameterBinding href "../ResourceParameterBinding/"
    

        
      PotentialOwner : scope
        
          
    
        
        
        PotentialOwner --> "0..1" BpmnModelElementInstance : scope
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/PotentialOwner.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:PotentialOwner |
| native | fluxnova_bpm_platform:PotentialOwner |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/PotentialOwner.java
description: The BPMN potentialOwner element
in_subset:
- instance
- fluxnova_bpmn_model
