...
_Sequence flows entering this flow node._
...
URI: [fluxnova_bpm_platform:incoming](https://w3id.org/TD-Universe/fluxnova-bpm-platform/incoming)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:incoming |
| native | fluxnova_bpm_platform:incoming |
