...
URI: [fluxnova_bpm_platform:SendTask](https://w3id.org/TD-Universe/fluxnova-bpm-platform/SendTask)
 ...
 classDiagram
    ...
    click SendTask href "../SendTask/"
      ...
      SendTask : auditing
        ...
        SendTask --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      SendTask : category_value_refs
        
          
    
        
        
        SendTask --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      SendTask : completion_quantity
        
      SendTask : data_input_associations
        
          
    
        
        
        SendTask --> "*" DataInputAssociation : data_input_associations
        click DataInputAssociation href "../DataInputAssociation/"
    

        
      SendTask : data_output_associations
        
          
    
        
        
        SendTask --> "*" DataOutputAssociation : data_output_associations
      ...
      SendTask : default
        ...
        SendTask --> "0..1" SequenceFlow : default
        click SequenceFlow href "../SequenceFlow/"
    

        
      SendTask : diagram_element
        
          
    
        
        
        SendTask --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      SendTask : documentations
        
          
    
        
        
        SendTask --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      SendTask : extension_elements
        
          
    
        
        
        SendTask --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      SendTask : fluxnova_async
        
      SendTask : fluxnova_async_after
        
      SendTask : fluxnova_async_before
        
      SendTask : fluxnova_class
        
      SendTask : fluxnova_delegate_expression
        
      SendTask : fluxnova_exclusive
        
      SendTask : fluxnova_expression
        
      SendTask : fluxnova_job_priority
        
      SendTask : fluxnova_result_variable
        
      SendTask : fluxnova_task_priority
        
      SendTask : fluxnova_topic
        
      SendTask : fluxnova_type
        
      SendTask : for_compensation
      ...
      SendTask : incoming
        ...
        SendTask --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      SendTask : io_specification
        
          
    
        
        
        SendTask --> "0..1" IoSpecification : io_specification
        click IoSpecification href "../IoSpecification/"
    

        
      SendTask : loop_characteristics
        
          
    
        
        
        SendTask --> "0..1" LoopCharacteristics : loop_characteristics
      ...
      SendTask : monitoring
        ...
        SendTask --> "0..1" Monitoring : monitoring
      ...
      SendTask : operation
        ...
        SendTask --> "0..1" Operation : operation
      ...
      SendTask : outgoing
        ...
        SendTask --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      SendTask : previous_nodes
        
          
    
        
        
        SendTask --> "0..1" FlowNode : previous_nodes
      ...
      SendTask : properties
        ...
        SendTask --> "*" BpmnProperty : properties
        click BpmnProperty href "../BpmnProperty/"
    

        
      SendTask : resource_roles
        
          
    
        
        
        SendTask --> "*" ResourceRole : resource_roles
      ...
      SendTask : scope
        ...
        SendTask --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      SendTask : start_quantity
        
      SendTask : succeeding_nodes
        
          
    
        
        
        SendTask --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/SendTask.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:SendTask |
| native | fluxnova_bpm_platform:SendTask |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/SendTask.java
description: The BPMN sendTask element
in_subset:
- instance
- fluxnova_bpmn_model
