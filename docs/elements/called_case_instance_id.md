...
# Slot: called_case_instance_id 


_The called case instance in case of (case) call activity_
...
URI: [fluxnova_bpm_platform:called_case_instance_id](https://w3id.org/TD-Universe/fluxnova-bpm-platform/called_case_instance_id)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:called_case_instance_id |
| native | fluxnova_bpm_platform:called_case_instance_id |
