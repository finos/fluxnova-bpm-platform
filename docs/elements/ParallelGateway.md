...
_The BPMN parallelGateway element_
...
URI: [fluxnova_bpm_platform:ParallelGateway](https://w3id.org/TD-Universe/fluxnova-bpm-platform/ParallelGateway)
...
```mermaid
 classDiagram
    class ParallelGateway
    click ParallelGateway href "../ParallelGateway/"
      Gateway <|-- ParallelGateway
        click Gateway href "../Gateway/"
      
      ParallelGateway : auditing
        
          
    
        
        
        ParallelGateway --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      ParallelGateway : category_value_refs
        
          
    
        
        
        ParallelGateway --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      ParallelGateway : diagram_element
        
          
    
        
        
        ParallelGateway --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      ParallelGateway : documentations
        
          
    
        
        
        ParallelGateway --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      ParallelGateway : extension_elements
        
          
    
        
        
        ParallelGateway --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      ParallelGateway : fluxnova_async
        
      ParallelGateway : fluxnova_async_after
        
      ParallelGateway : fluxnova_async_before
        
      ParallelGateway : fluxnova_exclusive
        
      ParallelGateway : fluxnova_job_priority
        
      ParallelGateway : gateway_direction
        
      ParallelGateway : id
        
      ParallelGateway : incoming
        
          
    
        
        
        ParallelGateway --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      ParallelGateway : monitoring
        
          
    
        
        
        ParallelGateway --> "0..1" Monitoring : monitoring
      ...
      ParallelGateway : outgoing
        ...
        ParallelGateway --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      ParallelGateway : previous_nodes
        
          
    
        
        
        ParallelGateway --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      ParallelGateway : scope
        
          
    
        
        
        ParallelGateway --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      ParallelGateway : succeeding_nodes
        
          
    
        
        
        ParallelGateway --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/ParallelGateway.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:ParallelGateway |
| native | fluxnova_bpm_platform:ParallelGateway |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/ParallelGateway.java
description: The BPMN parallelGateway element
in_subset:
- instance
- fluxnova_bpmn_model
