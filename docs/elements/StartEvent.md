...
URI: [fluxnova_bpm_platform:StartEvent](https://w3id.org/TD-Universe/fluxnova-bpm-platform/StartEvent)
...
```mermaid
 classDiagram
    class StartEvent
    click StartEvent href "../StartEvent/"
      ...
      StartEvent : auditing
        ...
        StartEvent --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      StartEvent : category_value_refs
        
          
    
        
        
        StartEvent --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      StartEvent : data_output_associations
        
          
    
        
        
        StartEvent --> "*" DataOutputAssociation : data_output_associations
        click DataOutputAssociation href "../DataOutputAssociation/"
    

        
      StartEvent : data_outputs
        
          
    
        
        
        StartEvent --> "*" DataOutput : data_outputs
        click DataOutput href "../DataOutput/"
    

        
      StartEvent : diagram_element
        
          
    
        
        
        StartEvent --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      StartEvent : documentations
        
          
    
        
        
        StartEvent --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      StartEvent : event_definition_refs
        
          
    
        
        
        StartEvent --> "*" EventDefinition : event_definition_refs
        click EventDefinition href "../EventDefinition/"
    

        
      StartEvent : event_definitions
        
          
    
        
        
        StartEvent --> "*" EventDefinition : event_definitions
        click EventDefinition href "../EventDefinition/"
    

        
      StartEvent : extension_elements
        
          
    
        
        
        StartEvent --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      StartEvent : fluxnova_async
        
      StartEvent : fluxnova_async_after
        
      StartEvent : fluxnova_async_before
        
      StartEvent : fluxnova_exclusive
        
      StartEvent : fluxnova_form_handler_class
        
      StartEvent : fluxnova_form_key
        
      StartEvent : fluxnova_form_ref
        
      StartEvent : fluxnova_form_ref_binding
        
      StartEvent : fluxnova_form_ref_version
        
      StartEvent : fluxnova_initiator
        
      StartEvent : fluxnova_job_priority
      ...
      StartEvent : incoming
        ...
        StartEvent --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      StartEvent : interrupting
        
      StartEvent : monitoring
        
          
    
        
        
        StartEvent --> "0..1" Monitoring : monitoring
      ...
      StartEvent : outgoing
        ...
        StartEvent --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      StartEvent : output_set
        
          
    
        
        
        StartEvent --> "0..1" OutputSet : output_set
        click OutputSet href "../OutputSet/"
    

        
      StartEvent : parallel_multiple
        
      StartEvent : previous_nodes
        
          
    
        
        
        StartEvent --> "0..1" FlowNode : previous_nodes
      ...
      StartEvent : properties
        ...
        StartEvent --> "*" BpmnProperty : properties
      ...
      StartEvent : scope
        ...
        StartEvent --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      StartEvent : succeeding_nodes
        
          
    
        
        
        StartEvent --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| ---  | --- | --- | --- |
| [interrupting](interrupting.md) | 0..1 <br/> [Boolean](Boolean.md) | Whether this start event interrupts the parent sub-process | direct |
...
| [fluxnova_initiator](fluxnova_initiator.md) | 0..1 <br/> [String](String.md) | Fluxnova extension property: initiator | direct |
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/StartEvent.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:StartEvent |
| native | fluxnova_bpm_platform:StartEvent |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/StartEvent.java
description: The BPMN startEvent element
in_subset:
- instance
- fluxnova_bpmn_model
...
attributes:
  interrupting:
    name: interrupting
    description: Whether this start event interrupts the parent sub-process.
    from_schema: https://w3id.org/TD-Universe/fluxnova-bpm-platform
    rank: 1000
    owner: StartEvent
    domain_of:
  ...
  fluxnova_form_ref_version:
    ...
    range: string
  fluxnova_initiator:
    name: fluxnova_initiator
    description: 'Fluxnova extension property: initiator.'
    from_schema: https://w3id.org/TD-Universe/fluxnova-bpm-platform
    rank: 1000
    owner: StartEvent
    domain_of:
