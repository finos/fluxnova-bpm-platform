...
_The BPMN intermediateThrowEvent element_
...
URI: [fluxnova_bpm_platform:IntermediateThrowEvent](https://w3id.org/TD-Universe/fluxnova-bpm-platform/IntermediateThrowEvent)
...
```mermaid
 classDiagram
    ...
    click IntermediateThrowEvent href "../IntermediateThrowEvent/"
      ...
      IntermediateThrowEvent : auditing
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      IntermediateThrowEvent : category_value_refs
        
          
    
        
        
        IntermediateThrowEvent --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      IntermediateThrowEvent : data_input_associations
        
          
    
        
        
        IntermediateThrowEvent --> "*" DataInputAssociation : data_input_associations
        click DataInputAssociation href "../DataInputAssociation/"
    

        
      IntermediateThrowEvent : data_inputs
        
          
    
        
        
        IntermediateThrowEvent --> "*" DataInput : data_inputs
        click DataInput href "../DataInput/"
    

        
      IntermediateThrowEvent : diagram_element
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      IntermediateThrowEvent : documentations
        
          
    
        
        
        IntermediateThrowEvent --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      IntermediateThrowEvent : event_definition_refs
        
          
    
        
        
        IntermediateThrowEvent --> "*" EventDefinition : event_definition_refs
        click EventDefinition href "../EventDefinition/"
    

        
      IntermediateThrowEvent : event_definitions
        
          
    
        
        
        IntermediateThrowEvent --> "*" EventDefinition : event_definitions
        click EventDefinition href "../EventDefinition/"
    

        
      IntermediateThrowEvent : extension_elements
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      IntermediateThrowEvent : fluxnova_async_after
        
      IntermediateThrowEvent : fluxnova_async_before
        
      IntermediateThrowEvent : fluxnova_exclusive
        
      IntermediateThrowEvent : fluxnova_job_priority
        
      IntermediateThrowEvent : id
        
      IntermediateThrowEvent : incoming
        
          
    
        
        
        IntermediateThrowEvent --> "*" SequenceFlow : incoming
        click SequenceFlow href "../SequenceFlow/"
    

        
      IntermediateThrowEvent : input_set
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" InputSet : input_set
        click InputSet href "../InputSet/"
    

        
      IntermediateThrowEvent : monitoring
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" Monitoring : monitoring
        click Monitoring href "../Monitoring/"
    

        
      IntermediateThrowEvent : name
        
      IntermediateThrowEvent : outgoing
        
          
    
        
        
        IntermediateThrowEvent --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      IntermediateThrowEvent : previous_nodes
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" FlowNode : previous_nodes
        click FlowNode href "../FlowNode/"
    

        
      IntermediateThrowEvent : properties
        
          
    
        
        
        IntermediateThrowEvent --> "*" BpmnProperty : properties
        click BpmnProperty href "../BpmnProperty/"
    

        
      IntermediateThrowEvent : scope
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      IntermediateThrowEvent : succeeding_nodes
        
          
    
        
        
        IntermediateThrowEvent --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| ---  | --- | --- | --- |
| [data_inputs](data_inputs.md) | * <br/> [DataInput](DataInput.md) | Input data elements of this specification | [ThrowEvent](ThrowEvent.md) |
| [data_input_associations](data_input_associations.md) | * <br/> [DataInputAssociation](DataInputAssociation.md) | Data associations that feed input data into this activity | [ThrowEvent](ThrowEvent.md) |
| [input_set](input_set.md) | 0..1 <br/> [InputSet](InputSet.md) | The input set associated with this input data | [ThrowEvent](ThrowEvent.md) |
| [event_definitions](event_definitions.md) | * <br/> [EventDefinition](EventDefinition.md) | Event definitions that specify the event trigger type | [ThrowEvent](ThrowEvent.md) |
| [event_definition_refs](event_definition_refs.md) | * <br/> [EventDefinition](EventDefinition.md) | Collection of event definition elements associated with this element | [ThrowEvent](ThrowEvent.md) |
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/IntermediateThrowEvent.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:IntermediateThrowEvent |
| native | fluxnova_bpm_platform:IntermediateThrowEvent |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/IntermediateThrowEvent.java
description: The BPMN intermediateThrowEvent element
in_subset:
- instance
- fluxnova_bpmn_model
