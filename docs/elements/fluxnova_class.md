...
URI: [fluxnova_bpm_platform:fluxnova_class](https://w3id.org/TD-Universe/fluxnova-bpm-platform/fluxnova_class)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:fluxnova_class |
| native | fluxnova_bpm_platform:fluxnova_class |
