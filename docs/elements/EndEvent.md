...
URI: [fluxnova_bpm_platform:EndEvent](https://w3id.org/TD-Universe/fluxnova-bpm-platform/EndEvent)
 ...
 classDiagram
    ...
    click EndEvent href "../EndEvent/"
      ...
      EndEvent : auditing
        ...
        EndEvent --> "0..1" Auditing : auditing
        click Auditing href "../Auditing/"
    

        
      EndEvent : category_value_refs
        
          
    
        
        
        EndEvent --> "*" CategoryValue : category_value_refs
        click CategoryValue href "../CategoryValue/"
    

        
      EndEvent : data_input_associations
        
          
    
        
        
        EndEvent --> "*" DataInputAssociation : data_input_associations
        click DataInputAssociation href "../DataInputAssociation/"
    

        
      EndEvent : data_inputs
        
          
    
        
        
        EndEvent --> "*" DataInput : data_inputs
        click DataInput href "../DataInput/"
    

        
      EndEvent : diagram_element
        
          
    
        
        
        EndEvent --> "0..1" DiagramElement : diagram_element
        click DiagramElement href "../DiagramElement/"
    

        
      EndEvent : documentations
        
          
    
        
        
        EndEvent --> "*" Documentation : documentations
        click Documentation href "../Documentation/"
    

        
      EndEvent : event_definition_refs
        
          
    
        
        
        EndEvent --> "*" EventDefinition : event_definition_refs
        click EventDefinition href "../EventDefinition/"
    

        
      EndEvent : event_definitions
        
          
    
        
        
        EndEvent --> "*" EventDefinition : event_definitions
        click EventDefinition href "../EventDefinition/"
    

        
      EndEvent : extension_elements
        
          
    
        
        
        EndEvent --> "0..1" ExtensionElements : extension_elements
        click ExtensionElements href "../ExtensionElements/"
    

        
      EndEvent : fluxnova_async_after
        
      EndEvent : fluxnova_async_before
        
      EndEvent : fluxnova_exclusive
        
      EndEvent : fluxnova_job_priority
      ...
      EndEvent : incoming
        ...
        EndEvent --> "*" SequenceFlow : incoming
      ...
      EndEvent : input_set
        ...
        EndEvent --> "0..1" InputSet : input_set
      ...
      EndEvent : monitoring
        ...
        EndEvent --> "0..1" Monitoring : monitoring
      ...
      EndEvent : outgoing
        ...
        EndEvent --> "*" SequenceFlow : outgoing
        click SequenceFlow href "../SequenceFlow/"
    

        
      EndEvent : previous_nodes
        
          
    
        
        
        EndEvent --> "0..1" FlowNode : previous_nodes
      ...
      EndEvent : properties
        ...
        EndEvent --> "*" BpmnProperty : properties
      ...
      EndEvent : scope
        ...
        EndEvent --> "0..1" BpmnModelElementInstance : scope
        click BpmnModelElementInstance href "../BpmnModelElementInstance/"
    

        
      EndEvent : succeeding_nodes
        
          
    
        
        
        EndEvent --> "0..1" FlowNode : succeeding_nodes
        click FlowNode href "../FlowNode/"
...
| source_file | model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/EndEvent.java |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:EndEvent |
| native | fluxnova_bpm_platform:EndEvent |
...
annotations:
  ...
  source_file:
    tag: source_file
    value: model-api/bpmn-model/src/main/java/org/finos/fluxnova/bpm/model/bpmn/instance/EndEvent.java
description: The BPMN endEvent element
in_subset:
- instance
- fluxnova_bpmn_model
