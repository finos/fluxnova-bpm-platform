...
# Slot: fluxnova_async_after 


_Whether this element is executed asynchronously after its end._
...
URI: [fluxnova_bpm_platform:fluxnova_async_after](https://w3id.org/TD-Universe/fluxnova-bpm-platform/fluxnova_async_after)
...
| Domain Of | [FlowNode](FlowNode.md), [MultiInstanceLoopCharacteristics](MultiInstanceLoopCharacteristics.md) |
...
| ---  | ---  |
| self | fluxnova_bpm_platform:fluxnova_async_after |
| native | fluxnova_bpm_platform:fluxnova_async_after |
