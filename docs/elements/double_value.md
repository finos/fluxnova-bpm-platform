...
_Variable value stored as double._
...
URI: [fluxnova_bpm_platform:double_value](https://w3id.org/TD-Universe/fluxnova-bpm-platform/double_value)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:double_value |
| native | fluxnova_bpm_platform:double_value |
