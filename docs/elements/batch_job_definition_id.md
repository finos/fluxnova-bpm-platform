...
URI: [fluxnova_bpm_platform:batch_job_definition_id](https://w3id.org/TD-Universe/fluxnova-bpm-platform/batch_job_definition_id)
...
| ---  | ---  |
| self | fluxnova_bpm_platform:batch_job_definition_id |
| native | fluxnova_bpm_platform:batch_job_definition_id |
