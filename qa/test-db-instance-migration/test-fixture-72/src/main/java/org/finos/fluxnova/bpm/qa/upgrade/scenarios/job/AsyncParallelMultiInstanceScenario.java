...
public class AsyncParallelMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeSubprocessProcess() {
    return "org/finos/fluxnova/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTaskProcess() {
    return "org/finos/fluxnova/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceTask.bpmn20.xml";
  }
