...
public class NonInterruptingBoundaryEventScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/finos/fluxnova/bpm/qa/upgrade/boundary/nonInterruptingTimerBoundaryEvent.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/finos/fluxnova/bpm/qa/upgrade/boundary/nonInterruptingMessageBoundaryEvent.bpmn20.xml";
  }
