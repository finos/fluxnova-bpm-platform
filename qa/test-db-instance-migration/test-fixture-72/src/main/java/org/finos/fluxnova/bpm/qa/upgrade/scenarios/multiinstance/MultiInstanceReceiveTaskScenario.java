...
public class MultiInstanceReceiveTaskScenario {
  ...
  public static String deployProcessParallel() {
    return "org/finos/fluxnova/bpm/qa/upgrade/multiinstance/parallelMultiInstanceReceiveTask.bpmn20.xml";
  }

  @Deployment
  public static String deployProcessSequential() {
    return "org/finos/fluxnova/bpm/qa/upgrade/multiinstance/sequentialMultiInstanceReceiveTask.bpmn20.xml";
  }
