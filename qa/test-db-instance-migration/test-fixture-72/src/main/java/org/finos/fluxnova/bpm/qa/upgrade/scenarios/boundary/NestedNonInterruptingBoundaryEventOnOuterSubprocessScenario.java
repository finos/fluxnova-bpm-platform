...
public class NestedNonInterruptingBoundaryEventOnOuterSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/finos/fluxnova/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/finos/fluxnova/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }
