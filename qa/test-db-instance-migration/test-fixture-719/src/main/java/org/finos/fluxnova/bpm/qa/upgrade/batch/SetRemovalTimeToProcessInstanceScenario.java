 ...
 */
package org.finos.fluxnova.bpm.qa.upgrade.batch;
...
public class SetRemovalTimeToProcessInstanceScenario {
  ...
  public static String deployOneTask() {
    return "org/finos/fluxnova/bpm/qa/upgrade/batch/SetRemovalTimeToProcessInstanceScenario.oneTaskProcess.bpmn20.xml";
  }
