 ...
 */
package org.finos.fluxnova.bpm.qa.upgrade.variables;
...
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.jpa.EntityManagerSession;
import org.finos.fluxnova.bpm.engine.impl.variable.serializer.jpa.EntityManagerSessionFactory;
...
public class JpaVariableScenario {
  ...
  public static String deployOneTask() {
    return "org/finos/fluxnova/bpm/qa/upgrade/variables/JpaEntitiesScenario.oneTaskProcess.bpmn20.xml";
  }
