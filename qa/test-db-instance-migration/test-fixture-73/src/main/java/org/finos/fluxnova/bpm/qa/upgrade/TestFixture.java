...
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.InterruptingEventSubProcessNestedCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.NestedCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.NestedMultiInstanceCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.NonInterruptingEventSubProcessCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.ParallelMultiInstanceCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.SequentialMultiInstanceCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.SingleActivityCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.compensation.SingleActivityConcurrentCompensationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.job.JobMigrationScenario;
import org.finos.fluxnova.bpm.qa.upgrade.scenarios.sentry.SentryScenario;
