...
public class NestedMultiInstanceCompensationScenario {
  ...
  public static String deployThrowInnerProcess() {
    return "org/finos/fluxnova/bpm/qa/upgrade/compensation/nestedMultiInstanceCompensationThrowInnerProcess.bpmn20.xml";
  }

  @Deployment
  public static String deployThrowOuterProcess() {
    return "org/finos/fluxnova/bpm/qa/upgrade/compensation/nestedMultiInstanceCompensationThrowOuterProcess.bpmn20.xml";
  }
