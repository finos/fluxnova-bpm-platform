...
public class FlowaveBpmRunAdministratorAuthorizationProperties extends AdministratorAuthorizationPlugin {

  public static final String PREFIX = FlowaveBpmRunProperties.PREFIX + ".admin-auth";
