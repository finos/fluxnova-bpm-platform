 ...
 */
package org.finos.fluxnova.bpm.run.utils;
...
import org.finos.fluxnova.bpm.spring.boot.starter.util.SpringBootStarterPropertyHelper;

public class FluxnovaBpmRunProcessEnginePluginHelper {

  protected static final FluxnovaBpmRunLogger LOG = FluxnovaBpmRunLogger.LOG;

  public static void registerYamlPlugins(List<ProcessEnginePlugin> processEnginePlugins,
                                         List<FluxnovaBpmRunProcessEnginePluginProperty> pluginsInfo) {

    for (FluxnovaBpmRunProcessEnginePluginProperty pluginInfo : pluginsInfo) {
