...
public class FluxnovaBpmRunLdapProperties extends LdapIdentityProviderPlugin {

  public static final String PREFIX = FluxnovaBpmRunProperties.PREFIX + ".ldap";
  ...
  public String toString() {
    return "CamundaBpmRunLdapProperty [enabled=" + enabled +
        ...
        ", userEmailAttribute=" + userEmailAttribute +
            ...
            // commons/logging/src/main/java/org/finos/fluxnova/commons/logging/BaseLogger.java
