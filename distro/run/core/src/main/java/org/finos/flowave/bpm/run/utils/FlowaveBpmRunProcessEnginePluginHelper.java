...
public class FlowaveBpmRunProcessEnginePluginHelper {

  protected static final FlowaveBpmRunLogger LOG = FlowaveBpmRunLogger.LOG;

  public static void registerYamlPlugins(List<ProcessEnginePlugin> processEnginePlugins,
                                         List<FlowaveBpmRunProcessEnginePluginProperty> pluginsInfo) {

    for (FlowaveBpmRunProcessEnginePluginProperty pluginInfo : pluginsInfo) {
