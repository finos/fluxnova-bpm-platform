...
public class FluxnovaBpmRunLogger extends BaseLogger {

  public static final String PROJECT_CODE = "RUN";
  public static final String PROJECT_ID = "CR";
  public static final String PACKAGE = "org.finos.fluxnova.bpm.run";

  public static final FluxnovaBpmRunLogger LOG = createLogger(FluxnovaBpmRunLogger.class, PROJECT_CODE, PACKAGE, PROJECT_ID);
