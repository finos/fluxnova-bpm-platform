...
public class FluxnovaBpmRunAdministratorAuthorizationProperties extends AdministratorAuthorizationPlugin {

  public static final String PREFIX = FluxnovaBpmRunProperties.PREFIX + ".admin-auth";
