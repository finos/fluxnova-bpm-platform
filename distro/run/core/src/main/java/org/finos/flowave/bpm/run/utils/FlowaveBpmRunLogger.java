...
public class FlowaveBpmRunLogger extends BaseLogger {
  ...
  public static final FlowaveBpmRunLogger LOG = createLogger(FlowaveBpmRunLogger.class, PROJECT_CODE, PACKAGE, PROJECT_ID);
