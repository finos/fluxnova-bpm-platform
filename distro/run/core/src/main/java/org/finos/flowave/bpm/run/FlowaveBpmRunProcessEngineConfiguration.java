...
import org.finos.flowave.bpm.run.utils.FlowaveBpmRunProcessEnginePluginHelper;
...
public class FlowaveBpmRunProcessEngineConfiguration extends SpringProcessEngineConfiguration {

  private final String normalizedDeploymentDir;

  public FlowaveBpmRunProcessEngineConfiguration(String normalizedDeploymentDir,
                                                 boolean deployChangedOnly,
                                                 List<ProcessEnginePlugin> processEnginePluginsFromContext,
                                                 List<FlowaveBpmRunProcessEnginePluginProperty> processEnginePluginsFromYaml) {
  ...
  protected void configureProcessEnginePlugins(List<ProcessEnginePlugin> processEnginePluginsFromContext,
    ...
    FlowaveBpmRunProcessEnginePluginHelper.registerYamlPlugins(processEnginePluginsFromContext, processEnginePluginsFromYaml);
