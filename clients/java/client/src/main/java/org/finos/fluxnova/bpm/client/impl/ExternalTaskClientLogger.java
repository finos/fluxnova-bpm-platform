...
import org.finos.fluxnova.bpm.client.exception.ConnectionLostException;
...
import org.finos.fluxnova.bpm.client.topic.impl.TopicSubscriptionManagerLogger;
import org.finos.fluxnova.bpm.client.variable.impl.format.json.JacksonJsonLogger;
import org.finos.fluxnova.bpm.client.variable.impl.format.serializable.SerializableLogger;
import org.finos.fluxnova.bpm.client.variable.impl.format.xml.DomXmlLogger;
...
public class ExternalTaskClientLogger extends BaseLogger {
  ...
  protected static final String PROJECT_LOGGER = "org.finos.fluxnova.bpm.client";
