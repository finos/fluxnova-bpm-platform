 ...
 */
package org.finos.fluxnova.bpm.client.util;
...
public class ProcessModels {
  ...
  public static final BpmnModelInstance TWO_PRIORITISED_EXTERNAL_TASKS_PROCESS =
      newModel()
          .startEvent("startEvent")
            ...
            .serviceTask(EXTERNAL_TASK_ONE_ID)
              .fluxnovaExternalTask(EXTERNAL_TASK_TOPIC_FOO)
                .fluxnovaTaskPriority(String.valueOf(EXTERNAL_TASK_PRIORITY))
            .endEvent("endEvent1")
            .moveToLastGateway()
            .serviceTask(EXTERNAL_TASK_TWO_ID)
              .fluxnovaExternalTask(EXTERNAL_TASK_TOPIC_FOO)
                .fluxnovaTaskPriority(String.valueOf(EXTERNAL_TASK_PRIORITY + 1000L))
            .endEvent("endEvent2")
            .done();
  ...
  public static final BpmnModelInstance ONE_EXTERNAL_TASK_WITH_OUTPUT_PARAM_PROCESS =
      ...
      .serviceTask(EXTERNAL_TASK_ID)
        .fluxnovaExternalTask(EXTERNAL_TASK_TOPIC_FOO)
        .fluxnovaOutputParameter("bar", "${foo}")
      .userTask(USER_TASK_ID)
      .endEvent("endEvent")
      .done();
  ...
  public static final BpmnModelInstance ONE_EXTERNAL_TASK_WITH_VERSION_TAG =
      ...
      .fluxnovaVersionTag(PROCESS_DEFINITION_VERSION_TAG)
      .startEvent()
      .serviceTask(EXTERNAL_TASK_ID)
        .fluxnovaExternalTask(EXTERNAL_TASK_TOPIC_FOO)
      .endEvent()
  ...
  public static final BpmnModelInstance BPMN_ERROR_EXTERNAL_TASK_WITH_OUTPUT_MAPPING_PROCESS =
      ...
      .serviceTask(EXTERNAL_TASK_ID)
        ...
        .fluxnovaTaskPriority(String.valueOf(EXTERNAL_TASK_PRIORITY))
        .fluxnovaOutputParameter("bar", "${foo}")
        .fluxnovaErrorEventDefinition().id("id").error("500", "errorMessage").expression("${true}").errorEventDefinitionDone()
      .userTask(USER_TASK_ID)
      .endEvent()
      .moveToActivity(EXTERNAL_TASK_ID)
      .boundaryEvent("catchBPMNError")
