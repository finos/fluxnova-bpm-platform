...
public class FindFlowaveFormDefinitionsCmd implements Command<List<FlowaveFormDefinition>> {

  @Override
  @SuppressWarnings("unchecked")
  public List<FlowaveFormDefinition> execute(CommandContext commandContext) {
