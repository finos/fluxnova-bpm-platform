...
public class ReuseEntityCacheTest {
  ...
  protected static final BpmnModelInstance PROCESS = Bpmn.createExecutableProcess("process")
      .startEvent()
      .serviceTask()
        .flowaveClass(CreateEntitiesDelegate.class.getName())
        .flowaveAsyncBefore()
        .flowaveExclusive(true)
      .serviceTask().flowaveClass(UpdateEntitiesDelegate.class.getName())
        .flowaveAsyncBefore()
        .flowaveExclusive(true)
      .serviceTask().flowaveClass(RemoveEntitiesDelegate.class.getName())
        .flowaveAsyncBefore()
        .flowaveExclusive(true)
      .endEvent()
      .done();
