...
public class PersistenceExceptionTest {
  ...
  public void testPersistenceExceptionContainsRealCause() {
    ...
    final BpmnModelInstance modelInstance = Bpmn.createExecutableProcess("process1").flowaveHistoryTimeToLive(180).startEvent().userTask(longString.toString()).endEvent().done();
