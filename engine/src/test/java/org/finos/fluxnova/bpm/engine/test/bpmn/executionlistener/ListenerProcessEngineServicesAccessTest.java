...
import org.finos.fluxnova.bpm.engine.test.bpmn.common.AbstractProcessEngineServicesAccessTest;
import org.finos.fluxnova.bpm.model.bpmn.BpmnModelInstance;
import org.finos.fluxnova.bpm.model.bpmn.instance.ManualTask;
...
public class ListenerProcessEngineServicesAccessTest extends AbstractProcessEngineServicesAccessTest {
  ...
  protected Task createModelAccessTask(BpmnModelInstance modelInstance, Class<?> delegateClass) {
    ...
    FluxnovaExecutionListener executionListener = modelInstance.newInstance(FluxnovaExecutionListener.class);
    executionListener.setFluxnovaEvent(ExecutionListener.EVENTNAME_START);
    executionListener.setFluxnovaClass(delegateClass.getName());
