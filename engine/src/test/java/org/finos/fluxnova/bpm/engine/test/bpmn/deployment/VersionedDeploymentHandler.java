...
public class VersionedDeploymentHandler implements DeploymentHandler {
  ...
  public boolean shouldDeployResource(Resource newResource, Resource existingResource) {
    ...
    if (isBpmnResource(newResource)) {
      ...
      Integer existingVersion = parseFluxnovaVersionTag(existingResource);
      Integer newVersion = parseFluxnovaVersionTag(newResource);
  ...
  protected Integer parseFluxnovaVersionTag(Resource resource) {
    ...
    return process.getFluxnovaVersionTag() != null ?
        Integer.parseInt(process.getFluxnovaVersionTag()) :
        0;
  }
