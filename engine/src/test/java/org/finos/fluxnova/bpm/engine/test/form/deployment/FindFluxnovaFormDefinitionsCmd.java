...
public class FindFluxnovaFormDefinitionsCmd implements Command<List<FluxnovaFormDefinition>> {

  @Override
  @SuppressWarnings("unchecked")
  public List<FluxnovaFormDefinition> execute(CommandContext commandContext) {
