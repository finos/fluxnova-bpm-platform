...
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupContext;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
import org.finos.fluxnova.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobDeclaration;
...
public class HistoryCleanupCmd implements Command<Job> {
  ...
  public Job execute(CommandContext context) {
    ...
    authorizationManager.checkFluxnovaAdmin();
