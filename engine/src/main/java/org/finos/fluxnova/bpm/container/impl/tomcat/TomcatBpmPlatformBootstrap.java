 ...
 */
package org.finos.fluxnova.bpm.container.impl.tomcat;
...
import org.finos.fluxnova.bpm.container.impl.deployment.jobexecutor.StartManagedThreadPoolStep;
import org.finos.fluxnova.bpm.container.impl.deployment.jobexecutor.StopJobExecutorStep;
import org.finos.fluxnova.bpm.container.impl.deployment.jobexecutor.StopManagedThreadPoolStep;
import org.finos.fluxnova.bpm.container.impl.tomcat.deployment.TomcatAttachments;
...
public class TomcatBpmPlatformBootstrap implements LifecycleListener {
  ...
  protected void deployBpmPlatform(LifecycleEvent event) {
    ...
    LOG.fluxnovaBpmPlatformSuccessfullyStarted(server.getServerInfo());
  ...
  protected void undeployBpmPlatform(LifecycleEvent event) {
    ...
    LOG.fluxnovaBpmPlatformStopped(server.getServerInfo());
  }
