...
import org.finos.fluxnova.bpm.engine.query.NativeQuery;

/**
 * Allows querying of {@link org.finos.fluxnova.bpm.engine.history.HistoricVariableInstanceQuery}s via native (SQL) queries
 * @author Ramona Koch
 */
