...
import org.finos.fluxnova.bpm.engine.impl.ProcessEngineInfoImpl;
 ...
 * (<code>org.finos.fluxnova.bpm.engine.test..impl.servlet.listener.ProcessEnginesServletContextListener</code>).  That way,
...
public abstract class ProcessEngines {
  ...
  protected static void initProcessEngineFromSpringResource(URL resource) {
    try {
      Class< ? > springConfigurationHelperClass = ReflectUtil.loadClass("org.finos.fluxnova.bpm.engine.spring.SpringConfigurationHelper");
