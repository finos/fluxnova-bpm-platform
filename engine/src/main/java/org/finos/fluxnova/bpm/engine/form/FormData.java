...
public interface FormData {
   ...
   *
   * A form can be referenced either through a form key or through a {@link FluxnovaFormRef}.
   *
   */
  String getFormKey();

  /**
   * User-defined reference to a form. A {@link FluxnovaFormRef} can specify any
   ...
   *
   */
  FluxnovaFormRef getFluxnovaFormRef();
