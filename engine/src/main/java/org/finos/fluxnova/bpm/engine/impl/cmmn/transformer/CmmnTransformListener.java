...
public interface CmmnTransformListener {
  ...
  /**
   * @deprecated use {@link #transformCasePlanModel(org.finos.fluxnova.bpm.model.cmmn.instance.CasePlanModel, CmmnActivity)}
   */
  @Deprecated
  void transformCasePlanModel(org.finos.fluxnova.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity);
