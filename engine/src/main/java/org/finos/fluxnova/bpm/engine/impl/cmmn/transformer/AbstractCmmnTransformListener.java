...
public class AbstractCmmnTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(org.finos.fluxnova.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity activity) {
    transformCasePlanModel((org.finos.fluxnova.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, activity);
  }
