...
import static org.finos.fluxnova.bpm.engine.impl.util.ExceptionUtil.createExceptionByteArray;
...
public class ExternalTaskEntity implements ExternalTask, DbEntity,
  ...
  protected boolean evaluateThrowBpmnError(ExecutionEntity execution, boolean continueOnException) {
    List<FluxnovaErrorEventDefinition> camundaErrorEventDefinitions = (List<FluxnovaErrorEventDefinition>) execution.getActivity().getProperty(BpmnProperties.CAMUNDA_ERROR_EVENT_DEFINITION.getName());
    if (camundaErrorEventDefinitions != null && !camundaErrorEventDefinitions.isEmpty()) {
      for (FluxnovaErrorEventDefinition camundaErrorEventDefinition : camundaErrorEventDefinitions) {
  ...
  protected boolean errorEventDefinitionMatches(FluxnovaErrorEventDefinition camundaErrorEventDefinition, boolean continueOnException) {
    try {
