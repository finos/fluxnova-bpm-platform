...
import org.finos.fluxnova.bpm.engine.impl.batch.DeleteBatchCmd;
import org.finos.fluxnova.bpm.engine.impl.cfg.CommandChecker;
import org.finos.fluxnova.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl;
import org.finos.fluxnova.bpm.engine.impl.cmd.ActivateBatchCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.DeleteJobCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.DeleteLicenseKeyCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.DeleteMetricsCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.DeletePropertyCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.DeleteTaskMetricsCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetHistoryLevelCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetJobExceptionStacktraceCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetLicenseKeyCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetProcessApplicationForDeploymentCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetPropertiesCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetTableCountCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetTableMetaDataCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetTableNameCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetTelemetryDataCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.GetUniqueTaskWorkerCountCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.IsTelemetryEnabledCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.PurgeDatabaseAndCacheCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.RecalculateJobDuedateCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.RegisterDeploymentCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.RegisterProcessApplicationCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.ReportDbMetricsCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SetJobDefinitionPriorityCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SetJobDuedateCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SetJobPriorityCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SetLicenseKeyCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SetPropertyCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.SuspendBatchCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.TelemetryConfigureCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.UnregisterDeploymentCmd;
import org.finos.fluxnova.bpm.engine.impl.cmd.UnregisterProcessApplicationCmd;
...
import org.finos.fluxnova.bpm.engine.impl.management.SetJobRetriesBuilderImpl;
import org.finos.fluxnova.bpm.engine.impl.management.SetJobRetriesByJobsAsyncBuilderImpl;
import org.finos.fluxnova.bpm.engine.impl.management.SetJobRetriesByProcessAsyncBuilderImpl;
...
import org.finos.fluxnova.bpm.engine.management.TablePageQuery;
...
public class ManagementServiceImpl extends ServiceImpl implements ManagementService {
  ...
  protected class DbSchemaUpgradeCmd implements Command<String> {
    ...
    public String execute(CommandContext commandContext) {
      commandContext.getAuthorizationManager().checkFluxnovaAdmin();
  ...
  protected class GetRegisteredDeploymentsCmd implements Command<Set<String>> {
    ...
    public Set<String> execute(CommandContext commandContext) {
      commandContext.getAuthorizationManager().checkFluxnovaAdminOrPermission(CommandChecker::checkReadRegisteredDeployments);
