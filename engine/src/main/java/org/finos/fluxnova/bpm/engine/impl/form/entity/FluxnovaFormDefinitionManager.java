 ...
 */
package org.finos.fluxnova.bpm.engine.impl.form.entity;
...
public class FluxnovaFormDefinitionManager extends AbstractManager
  ...
  public CamundaFormDefinitionEntity findLatestDefinitionByKey(String key) {
    ...
    if (camundaFormDefinitions.isEmpty()) {
      ...
      throw LOG.multipleTenantsForFluxnovaFormDefinitionKeyException(key);
    }
  }
  ...
  public void deleteFluxnovaFormDefinitionsByDeploymentId(String deploymentId) {
