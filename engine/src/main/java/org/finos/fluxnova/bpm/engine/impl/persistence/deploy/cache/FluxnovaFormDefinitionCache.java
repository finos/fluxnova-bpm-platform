...
import org.finos.fluxnova.bpm.engine.impl.persistence.AbstractResourceDefinitionManager;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.CamundaFormDefinitionEntity;

public class FluxnovaFormDefinitionCache extends ResourceDefinitionCache<CamundaFormDefinitionEntity> {

  public FluxnovaFormDefinitionCache(CacheFactory factory, int cacheCapacity, CacheDeployer cacheDeployer) {
  ...
  protected AbstractResourceDefinitionManager<CamundaFormDefinitionEntity> getManager() {
    return Context.getCommandContext().getFluxnovaFormDefinitionManager();
  }
