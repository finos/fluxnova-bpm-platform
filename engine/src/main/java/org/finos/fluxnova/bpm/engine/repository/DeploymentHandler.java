 ...
 * through the
 * {@link org.finos.fluxnova.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl#setDeploymentHandlerFactory(DeploymentHandlerFactory)}
 * method.</p>
 *
 * <p>See {@link org.finos.fluxnova.bpm.engine.impl.repository.DefaultDeploymentHandler} for the default
...
public interface DeploymentHandler {
   ...
   * {@link org.finos.fluxnova.bpm.engine.impl.repository.DefaultDeploymentHandler#shouldDeployResource(Resource, Resource)}.</p>
   *
   ...
   * {@link org.finos.fluxnova.bpm.engine.impl.jobexecutor.JobExecutor} and registered with the newly
