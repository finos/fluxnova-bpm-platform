...
public class TaskDefinition {
  ...
  public Expression getFluxnovaFormDefinitionKey() {
    return formDefinition.getFluxnovaFormDefinitionKey();
  }

  public String getFluxnovaFormDefinitionBinding() {
    return formDefinition.getFluxnovaFormDefinitionBinding();
  }

  public Expression getFluxnovaFormDefinitionVersion() {
    return formDefinition.getFluxnovaFormDefinitionVersion();
  }
