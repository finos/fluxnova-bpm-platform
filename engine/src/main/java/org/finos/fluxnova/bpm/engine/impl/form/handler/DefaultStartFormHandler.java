...
public class DefaultStartFormHandler extends DefaultFormHandler implements StartFormHandler {
  ...
  public StartFormData createStartFormData(ProcessDefinitionEntity processDefinition) {
    ...
    Expression camundaFormDefinitionKey = startFormDefinition.getFluxnovaFormDefinitionKey();
    String camundaFormDefinitionBinding = startFormDefinition.getFluxnovaFormDefinitionBinding();
    Expression camundaFormDefinitionVersion = startFormDefinition.getFluxnovaFormDefinitionVersion();
    ...
    if (formKey != null) {
      ...
      FluxnovaFormRefImpl ref = new FluxnovaFormRefImpl(camundaFormDefinitionKey.getExpressionText(), camundaFormDefinitionBinding);
      ...
      startFormData.setFluxnovaFormRef(ref);
    }
