...
import org.finos.fluxnova.bpm.engine.impl.cmd.DeleteProcessDefinitionsByIdsCmd;
...
public class DeploymentManager extends AbstractManager {
  ...
  public void deleteDeployment(String deploymentId, final boolean cascade, final boolean skipCustomListeners, boolean skipIoMappings) {
    ...
    deleteFluxnovaFormDefinitionDeployment(deploymentId);
  ...
  protected void deleteFluxnovaFormDefinitionDeployment(String deploymentId) {
    FluxnovaFormDefinitionManager manager = getFluxnovaFormDefinitionManager();
    ...
    manager.deleteFluxnovaFormDefinitionsByDeploymentId(deploymentId);

    // delete definitions from deployment cache
    ProcessEngineConfigurationImpl processEngineConfiguration = Context.getProcessEngineConfiguration();
    DeploymentCache deploymentCache = processEngineConfiguration.getDeploymentCache();
    for (CamundaFormDefinitionEntity camundaFormDefinition : camundaFormDefinitions) {
      deploymentCache.removeFluxnovaFormDefinition(camundaFormDefinition.getId());
    }
  }
