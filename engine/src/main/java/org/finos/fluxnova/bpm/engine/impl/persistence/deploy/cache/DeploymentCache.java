 ...
 */
package org.finos.fluxnova.bpm.engine.impl.persistence.deploy.cache;
...
public class DeploymentCache {
  ...
  protected FluxnovaFormDefinitionCache camundaFormDefinitionCache;
  ...
  public DeploymentCache(CacheFactory factory, int cacheCapacity) {
    ...
    camundaFormDefinitionCache = new FluxnovaFormDefinitionCache(factory, cacheCapacity, cacheDeployer);
  ...
  public void addFluxnovaFormDefinition(CamundaFormDefinitionEntity camundaFormDefinition) {
    camundaFormDefinitionCache.addDefinition(camundaFormDefinition);
  }

  public void removeFluxnovaFormDefinition(String camundaFormDefinitionId) {
    camundaFormDefinitionCache.removeDefinitionFromCache(camundaFormDefinitionId);
  }

  public void discardFluxnovaFormDefinitionCache() {
