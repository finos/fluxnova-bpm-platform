...
public class FlowaveFormDefinitionCache extends ResourceDefinitionCache<CamundaFormDefinitionEntity> {

  public FlowaveFormDefinitionCache(CacheFactory factory, int cacheCapacity, CacheDeployer cacheDeployer) {
