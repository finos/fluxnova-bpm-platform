 ...
 */
package org.finos.fluxnova.bpm.quarkus.engine.extension.impl;
...
import org.finos.fluxnova.bpm.engine.cdi.impl.event.CdiEventSupportBpmnParseListener;
...
import org.finos.fluxnova.bpm.quarkus.engine.extension.event.FluxnovaEngineStartupEvent;
import org.eclipse.microprofile.context.ManagedExecutor;

@Recorder
public class FluxnovaEngineRecorder {
  ...
  public void fireFluxnovaEngineStartEvent() {
    Arc.container().beanManager()
        .getEvent()
        .select(FluxnovaEngineStartupEvent.class)
        .fire(new FluxnovaEngineStartupEvent());
  }
