...
import org.finos.flowave.bpm.quarkus.engine.extension.FlowaveEngineConfig;
import org.finos.flowave.bpm.quarkus.engine.extension.QuarkusProcessEngineConfiguration;
import org.finos.flowave.bpm.quarkus.engine.extension.impl.FlowaveEngineRecorder;
import org.finos.flowave.bpm.quarkus.engine.extension.impl.InjectableBusinessProcessContext;
import org.jboss.jandex.DotName;

public class FlowaveEngineProcessor {
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void cdiConfig(FlowaveEngineRecorder recorder, BeanContainerBuildItem beanContainer) {
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void processEngineConfiguration(FlowaveEngineRecorder recorder,
                                            BeanContainerBuildItem beanContainerBuildItem,
                                            FlowaveEngineConfig camundaEngineConfig,
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void processEngine(FlowaveEngineRecorder recorder,
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void shutdown(FlowaveEngineRecorder recorder,
