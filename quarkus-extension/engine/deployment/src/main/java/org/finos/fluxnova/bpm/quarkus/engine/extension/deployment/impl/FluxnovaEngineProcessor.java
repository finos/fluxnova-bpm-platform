 ...
 */
package org.finos.fluxnova.bpm.quarkus.engine.extension.deployment.impl;
...
import org.finos.fluxnova.bpm.engine.cdi.ProcessVariables;
...
import org.finos.fluxnova.bpm.engine.cdi.impl.context.DefaultContextAssociationManager;
import org.finos.fluxnova.bpm.engine.cdi.impl.context.RequestScopedAssociation;
import org.finos.fluxnova.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl;
import org.finos.fluxnova.bpm.quarkus.engine.extension.FluxnovaEngineConfig;
import org.finos.fluxnova.bpm.quarkus.engine.extension.QuarkusProcessEngineConfiguration;
import org.finos.fluxnova.bpm.quarkus.engine.extension.impl.FluxnovaEngineRecorder;
import org.finos.fluxnova.bpm.quarkus.engine.extension.impl.InjectableBusinessProcessContext;
import org.jboss.jandex.DotName;

public class FluxnovaEngineProcessor {
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void cdiConfig(FluxnovaEngineRecorder recorder, BeanContainerBuildItem beanContainer) {
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void processEngineConfiguration(FluxnovaEngineRecorder recorder,
                                            BeanContainerBuildItem beanContainerBuildItem,
                                            FluxnovaEngineConfig camundaEngineConfig,
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void processEngine(FluxnovaEngineRecorder recorder,
  ...
  @BuildStep
  @Record(RUNTIME_INIT)
  protected void deployProcessEngineResources(FluxnovaEngineRecorder recorder) {
    recorder.fireFluxnovaEngineStartEvent();
  }

  @BuildStep
  @Record(RUNTIME_INIT)
  protected void shutdown(FluxnovaEngineRecorder recorder,
