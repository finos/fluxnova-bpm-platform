 ...
 */
package org.finos.fluxnova.bpm.quarkus.engine.test.config;
...
public class FluxnovaEngineProgrammaticAndConfigFileTest {

  @RegisterExtension
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("org/finos/fluxnova/bpm/quarkus/engine/test/config/mixed-application.properties")
