 ...
 */
package org.finos.fluxnova.bpm.quarkus.engine.test;

import static org.assertj.core.api.Assertions.assertThat;
import static org.finos.fluxnova.bpm.engine.impl.test.TestHelper.waitForJobExecutorToProcessAllJobs;
...
import org.finos.fluxnova.bpm.quarkus.engine.extension.impl.ManagedJobExecutor;
...
public class ManagedJobExecutorTest {
  ...
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("org/finos/fluxnova/bpm/quarkus/engine/test/config/" +
